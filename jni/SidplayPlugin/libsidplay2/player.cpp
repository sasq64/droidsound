...
int Player::load (SidTune *tune)
{
	...
	__android_log_print(ANDROID_LOG_VERBOSE, "SidplayPlugin", "UNMUTE");
	...
	__android_log_print(ANDROID_LOG_VERBOSE, "SidplayPlugin", "CONFIG");
...
void Player::writeMemByte_playsid (uint_least16_t addr, uint8_t data)
{
    ...
    else // Mirrored SID.
    {
		...
		//{
		//	sid_registers[ tempAddr & 0xff ] = data;
		//}
    }
}
