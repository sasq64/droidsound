...
/* pl */ {IDGS_PLAYBACK_ERROR_DIFFERENT_PL, "B3Å}d otwarzania: %s ro?ni sie od linii %d pliku debug%06d"},
...
/* pl */ {IDGS_CANT_CREATE_START_SNAP_S_PL, "Nie mo?na utworzya poczÅ}tkowego pliku zrzutu %s."},
...
/* pl */ {IDGS_ERROR_READING_END_SNAP_S_PL, "B3Å}d odczytu koncowego pliku zrzutu %s."},
...
/* pl */ {IDGS_ERROR_READING_START_SNAP_TRIED_PL, "B3Å}d odczytu poczÅ}tkowego pliku zrzutu. Wyprobowano %s i %s"},
...
/* pl */ {IDGS_ERROR_READING_START_SNAP_PL, "B3Å}d odczytu poczÅ}tkowego pliku zrzutu."},
...
/* pl */ {IDGS_SORRY_NO_MULTI_RECORDING_PL, "Przepraszamy, wieloÅ˜cie?kowy zapis nie jest obs3ugiwany."},
...
/* pl */ {IDGS_WRITE_TO_SOUND_DEVICE_FAILED_PL, "Zapis do urzÅ}dzenia d?wieku nie powiod3 sie."},
...
/* pl */ {IDGS_INIT_FAILED_FOR_DEVICE_S_PL, "Inicjalizacja urzÅ}dzenia `%s' nie powiod3a sie."},
...
/* pl */ {IDGS_DEVICE_S_NOT_FOUND_SUPPORT_PL, "Nie znaleziono urzÅ}dzenia '%s' lub jest ono niewspierane"},
...
/* pl */ {IDGS_RECORD_DEVICE_S_NOT_EXIST_PL, "UrzÅ}dzenie zapisu %s nie istnieje!"},
...
/* pl */ {IDGS_RECORD_DIFFERENT_PLAYBACK_PL, "UrzÅ}dzenie zapisu musi bya inne ni? urzÅ}dzenie odtwarzania"},
...
/* pl */ {IDGS_WARNING_RECORDING_REALTIME_PL, "Ostrze?enie! UrzÅ}dzenie zapisu %s dzia3a chyba w czasie rzeczywistym!"},
...
/* pl */ {IDGS_RECORD_NOT_SUPPORT_SOUND_PAR_PL, "UrzÅ}dzenie zapisu nie obs3uguje obecnych parametrow d?wieku"},
...
/* pl */ {IDGS_STORE_SOUNDDEVICE_FAILED_PL, "zapis do urzÅ}dzenia d?wieku nie powiod3 sie"},
...
/* pl */ {IDGS_CANNOT_CONNECT_TO_S_PL, "Nie mo?na pod3Å}czya do %s (na porcie %d nie dzia3a ?aden serwer)."},
...
/* pl */ {IDGS_NETWORK_OUT_OF_SYNC_PL, "Desynchronizacja sieci - roz3Å}czam."},
...
/* pl */ {IDGS_REMOTE_HOST_DISCONNECTED_PL, "Zdalny host roz3Å}czy3 sie."},
...
/* pl */ {IDGS_ALL_DEVICES_DETACHED_PL, ".\nWszystkie wymienione urzÅ}dzenia zostanÅ} odmontowane."},
...
/* pl */ {IDGS_ERROR_CREATING_FILE_S_PL, "B3Å}d tworzenia pliku %s!"},
...
/* pl */ {IDGS_ERROR_WRITING_TO_FILE_S_PL, "B3Å}d zapisu do pliku %s!"},
...
/* pl */ {IDGS_MON_BANK_DESCRIPTION_PL, "JeÅ˜li nie podano nazwy banku, pokazuje mo?liwe banki pamieci.\nJeÅ˜li podano nazwe banku, ustawia obecny bank pamieci na\ndany bank."},
...
/* pl */ {IDGS_MON_CPU_DESCRIPTION_PL, "OkreÅ˜l typ obecnie u?ywanego CPU (6502/z80)."},
...
/* pl */ {IDGS_MON_CPUHISTORY_DESCRIPTION_PL, "Pokazuje <iloÅ˜a> ostatnio wykonanych polecen."},
...
/* pl */ {IDGS_MON_EXPORT_DESCRIPTION_PL, "Wydrukuj liste pod3Å}czonych urzÅ}dzen portow rozszerzen."},
...
/* pl */ {IDGS_MON_NEXT_DESCRIPTION_PL, "Przechodzi do nastepnej instrukcji. Procedury sÅ} traktowane\njak pojedyncze instrukcje."},
...
/* pl */ {IDGS_MON_REGISTERS_DESCRIPTION_PL, "PrzyporzÅ}dkowuje odpowiednie rejestry. Bez podanych parametrow\npokazuje wartoÅ˜ci rejestrow."},
...
/* pl */ {IDGS_MON_SCREEN_DESCRIPTION_PL, "Pokazuje zawartoÅ˜a ekranu."},
...
/* pl */ {IDGS_MON_UNDUMP_DESCRIPTION_PL, "Odczytaj zrzut maszyny z okreÅ˜lonego pliku."},
...
/* pl */ {IDGS_MON_LOAD_LABELS_DESCRIPTION_PL, "Wczytuje plik zawierajÅ}cy mapowanie notatek pod adresy. JeÅ˜li nie\nokreÅ˜lono zakresu pamieci, u?ywany jest domyÅ˜lny zakres pamieci.\n\nFormat pliku jest zapisywany komendÅ}`save_labels',\nktora sk3ada sie z komend `add_label', zapisanych jedna po drugiej."},
...
/* pl */ {IDGS_MON_SAVE_LABELS_DESCRIPTION_PL, "Zapisuje notatki do pliku. JeÅ˜li nie okreÅ˜lono obszaru pamieci,\nzapisywanie sÅ} wszystkie notatki."},
...
/* pl */ {IDGS_MON_SHOW_LABELS_DESCRIPTION_PL, "Pokazuje obecne mapowania notatek. JeÅ˜li nie okreÅ˜lono obszaru pamieci,\npokazuje wszystkie notatki."},
...
/* pl */ {IDGS_MON_WRITE_DESCRIPTION_PL, "Zapisuje okreÅ˜lone dane w 'adresie'."},
...
/* pl */ {IDGS_MON_ASSEMBLE_DESCRIPTION_PL, "Assembluje instrukcje pod podanym adresem. JeÅ˜li podano tylko\njednÅ} instrukcje, wchodzi w tryb asemblowania (pusta linia\nwychodzi z trybu asemblowania)."},
...
/* pl */ {IDGS_MON_DISASS_DESCRIPTION_PL, "Deasembluje instrukcje. JeÅ˜li podano dwa adresy, u?ywane sÅ} jako\nadres poczÅ}tkowy i koncowy. JeÅ˜li podano tylko jeden, jest u?ywany\njako adres poczÅ}tkowy i deasemblowana jest domyÅ˜lna liczba instrukcji\nz adresu dot."},
...
/* pl */ {IDGS_MON_I_DESCRIPTION_PL, "Poka? zawartoÅ˜a pamieci jako tekst PETSCII."},
...
/* pl */ {IDGS_MON_II_DESCRIPTION_PL, "Poka? zawartoÅ˜a pamieci jako tekst screen code."},
...
/* pl */ {IDGS_MON_MEM_DESCRIPTION_PL, "Pokazuje zawartoÅ˜a pamieci. JeÅ˜li nie ustalono typu danych, jest\nu?ywany domyÅ˜lny. JeÅ˜li okreÅ˜lono tylko jeden adres, d3ugoÅ˜a\npokazanych danych zale?y od ich typu. JeÅ˜li nie podano adresu,\nu?ywany jest adres 'kropka'. Uwaga: w zwiÅ}zku z wieloznacznoÅ˜ciÅ} 'b' i 'd', te typy danych\nnale?y podaa wielkÅ} literÅ}!"},
...
/* pl */ {IDGS_MON_MEMCHAR_DESCRIPTION_PL, "Poka? zawartoÅ˜a pamieci jako dane znakowe. JeÅ˜li podano tylko jeden\nadres, pokazany jest tylko jeden znak. JeÅ˜li nie podano adresow, u?yty\njest adres 'kropka'."},
...
/* pl */ {IDGS_MON_MEMMAPSHOW_DESCRIPTION_PL, "Pokazuje mape pamieci. By pokazaa tylko obszar dostepow danego typu,\nmo?na okreÅ˜lia maske. Maska to numer zawierajÅ}cy bity \"ioRWXrwx\", gdzie\nRWX to ROM, a rwx to RAM. Opcjonalnie mo?na okreÅ˜lia zakres adresow."},
...
/* pl */ {IDGS_MON_MEMMAPZAP_DESCRIPTION_PL, "WyczyÅ˜a mape pamieci."},
...
/* pl */ {IDGS_MON_MEMSPRITE_DESCRIPTION_PL, "Pokazuje zawartoÅ˜a pamieci jako dane duszkow. JeÅ˜li podano tylko jeden\nadres, pokazywany jest tylko jeden duszek. JeÅ˜li nie podano adresu,\nu?ywany jest adres ``dot'."},
...
/* pl */ {IDGS_MON_MOVE_DESCRIPTION_PL, "Przesuwa pamiea z okreÅ˜lonego zakresu adresow pod podany adres.\nZakresy mogÅ} sie pokrywaa."},
...
/* pl */ {IDGS_MON_BREAK_DESCRIPTION_PL, "Ustawia punkt wstrzymania. JeÅ˜li nie podano adresu, pokazywane sÅ}\nobecnie aktywne punkty wstrzymania.\nJeÅ˜li podano adres, ustawiany jest punkt wstrzymania dla tego adresu\ni pokazywany jest numer punktu wstrzymania.\n`load|store|exec' to `load', `store' lub `exec' (albo ich po3Å}czenia),\nokreÅ˜lajÅ}ce  podczas ktorych operacji nastepuje b3Å}d. JeÅ˜li nic\nnie okreÅ˜lono, monitor przerywa dzia3anie na `exec'.\nMo?na rownie? okreÅ˜lia wyra?enie warunkowe dla punktu wstrzymania.\nBy znale?a wiecej informacji o warunkach, zobacz polecenie CONDITION."},
...
/* pl */ {IDGS_MON_COMMAND_DESCRIPTION_PL, "OkreÅ˜l 'command' jako polecenie do wykonania przy osiÅ}gnieciu punktu 'checknum.'\nPolecenie 'x' nie jest jeszcze obs3ugiwane jako argument polecenia."},
...
/* pl */ {IDGS_MON_CONDITION_DESCRIPTION_PL, "Za ka?dym razem, gdy analizowany jest punkt kontrolny, szacowany\njest stan. JeÅ˜li jest oszacowany na 'prawda', punkt kontrolny jest\nuaktywniany. W innym razie jest ignorowany. JeÅ˜li w wyra?eniu\npodano rejestry, u?ywane sÅ} wartoÅ˜ci z czasu szacowania punktu\nkontrolnego, nie z czasu ustawienia stanu.Stan mo?e korzystaa z rejestrow (.A, .X, .Y, .PC, .SP) i porownywaa je\n(==, !=, <, >, <=, >=) z innymi rejestrami lub sta3ymi. Rejestry mogÅ} bya\nrejestrami innych urzÅ}dzen, co jest okreÅ˜lone przedrostkiem przestrzeni\npamieci (np. c:, 8:, 9:, 10:, 11)\nPrzyk3ady: A == 0, .X == .Y, 8:.X == .X\n"},
...
/* pl */ {IDGS_MON_DISABLE_DESCRIPTION_PL, "Wy3Å}cz punkt kontrolny `checknum'."},
...
/* pl */ {IDGS_MON_ENABLE_DESCRIPTION_PL, "W3Å}cz punkt kontrolny `checknum'."},
...
/* pl */ {IDGS_MON_IGNORE_DESCRIPTION_PL, "Ignoruje punkt kontrolny danÅ} iloÅ˜a razy. JeÅ˜li nie podano tej iloÅ˜ci,\ndomyÅ˜lna wartoÅ˜a wynosi 1."},
...
/* pl */ {IDGS_MON_UNTIL_DESCRIPTION_PL, "JeÅ˜li nie podano adresu, pokazywane sÅ} obecne punkty wstrzymania.\nJeÅ˜li podano adres, ustawiany jest tymczasowy punkt wstrzymania\ni pokazywany jest numer punktu wstrzymania. To polecenie przywraca\nkontrole do emulatora. Punkt wstrzymania jest kasowany po jego osiÅ}gnieciu."},
...
/* pl */ {IDGS_MON_WATCH_DESCRIPTION_PL, "Ustawia punkt Å˜ledzenia. JeÅ˜li nie podano adresu, pokazywane sÅ}\nobecnie aktualne punkty Å˜ledzenia. JeÅ˜li okreÅ˜lono pojedynczy adres,\nustawia punkt Å˜ledzenia na ten adres. Jesli okreÅ˜lono dwa adresy,\nustawia punkt Å˜ledzenia dla obszaru pamieci pomiedzy tymi dwoma\nadresami.\n`load|store|exec' to `load', `store' lub `exec' (albo ich po3Å}czenia),\nokreÅ˜lajÅ}ce  podczas ktorych operacji nastepuje b3Å}d. JeÅ˜li nic\nnie okreÅ˜lono, monitor przerywa dzia3anie na `load' i `store'.\n"},
...
/* pl */ {IDGS_MON_TRACE_DESCRIPTION_PL, "Ustawia punkt Å˜ledzenia. JeÅ˜li nie podano adresu, pokazywane sÅ}\nw3aÅ˜ciwe obecnie punkty Å˜ledzenia. JeÅ˜li podano jeden adres,\nustawia punkt Å˜ledzenia tego adresu. JeÅ˜li podano dwa adresy,\nustawia punkt Å˜ledzenia obszaru pamieci pomiedzy nimi.\n`load|store|exec' to `load', `store' lub `exec' (albo ich po3Å}czenia),\nokreÅ˜lajÅ}ce  podczas ktorych operacji nastepuje b3Å}d. JeÅ˜li nic\nnie okreÅ˜lono, monitor Å˜ledzi wszystkie trzy rodzaje operacji.\n"},
...
/* pl */ {IDGS_MON_DEVICE_DESCRIPTION_PL, "Ustawia komputer `c:', lub okreÅ˜lonÅ} stacje dyskow (`8:', `9:')\njako domyÅ˜lne urzÅ}dzenie pamieci."},
...
/* pl */ {IDGS_MON_EXIT_DESCRIPTION_PL, "OpuÅ˜a monitor i wroa do wykonywania"},
...
/* pl */ {IDGS_MON_RADIX_DESCRIPTION_PL, "Ustawia domyÅ˜lny korzen na heksadecymalny, decymalny, oÅ˜emkowy\nlub binarny. Bez podanego argumentu, pokazywany jest obecny korzen."},
...
/* pl */ {IDGS_MON_SIDEFX_DESCRIPTION_PL, "Kontroluje w jaki sposob wygenerowane w monitorze odczyty po3o?enia\nwp3ywajÅ} na obszary pamieci, ktore majÅ} efekty uboczne odczytu.\nJeÅ˜li argument to 'on', wtedy odczyty mogÅ} powodowaa efekty uboczne.\nJeÅ˜li argument to 'off', wtedy odczyty nie powodujÅ} efektow ubocznych.\nJeÅ˜li argument to 'toggle', obecny tryb jest prze3Å}czany.\nBrak argumentu pokazuje obecny stan."},
...
/* pl */ {IDGS_MON_AUTOSTART_DESCRIPTION_PL, "automatycznie uruchom dany program albo obraz dysku lub taÅ˜my"},
...
/* pl */ {IDGS_MON_AUTOLOAD_DESCRIPTION_PL, "automatycznie wczytaj dany program albo obraz dysku lub taÅ˜my"},
...
/* pl */ {IDGS_MON_ATTACH_DESCRIPTION_PL, "Pod3Å}cz plik pod urzÅ}dzenie (urzÅ}dzenie 32 = cart)"},
...
/* pl */ {IDGS_MON_BLOAD_DESCRIPTION_PL, "Wczytaj dany plik do pamieci w okreÅ˜lonym adresie.\nJeÅ˜li urzÅ}dzenie to 0, plik jest czytany z systemu plikow."},
...
/* pl */ {IDGS_MON_BLOCK_READ_DESCRIPTION_PL, "Czytaj blok z danej Å˜cie?ki i sektora. JeÅ˜li okreÅ˜lono adres, dane sÅ}\nwczytywane do pamieci. JeÅ˜li nie podano adresu, dane sÅ} pokazane\nw domyÅ˜lnym typie danych."},
...
/* pl */ {IDGS_MON_BSAVE_DESCRIPTION_PL, "Zapisz pamiea z adres1 do adres2 do okreÅ˜lonego pliku.\nJeÅ˜li urzÅ}dzenie to 0, plik jest zapisywany do systemu plikow."},
...
/* pl */ {IDGS_MON_BLOCK_WRITE_DESCRIPTION_PL, "Zapisz blok danych w `address' w podanej Å˜cie?ce i sektorze\ndysku w stacji 8."},
...
/* pl */ {IDGS_MON_DETACH_DESCRIPTION_PL, "Od3Å}cz plik od urzÅ}dzenia (urzÅ}dzenie 32 = cart)"},
...
/* pl */ {IDGS_MON_DIR_DESCRIPTION_PL, "Poka? zawartoÅ˜a katalogu."},
...
/* pl */ {IDGS_MON_LIST_DESCRIPTION_PL, "Poka? zawartoÅ˜a dysku"},
...
/* pl */ {IDGS_MON_LOAD_DESCRIPTION_PL, "Wczytaj podany plik do pamieci w konkretnym adresie. Ustaw wska?niki\nBASIC odpowiednio, jesli zostanÅ} wczytane do pamieci komputera\n(nie wszystkie emulatory). U?yj (w innym razie ignoruje) dwubajtowego\nadresu wczytywania z pliku, jeÅ˜li nie zosta3 podany adres.\nJeÅ˜li urzÅ}dzenie jest 0, plik zostaje oczytany z systemu plikow."},
...
/* pl */ {IDGS_MON_DISPLAY_NUMBER_DESCRIPTION_PL, "Poka? danÅ} liczbe w systemie dziesietnym, szesnastkowym, osemkowym i binarnym."},
...
/* pl */ {IDGS_MON_HELP_DESCRIPTION_PL, "JeÅ˜li nie jest podany argument, pokazuje liste dostepnych polecen.\nJeÅ˜li zosta3 podany argument, pokazuje pomoc do tego polecenia."},
...
/* pl */ {IDGS_MON_KEYBUF_DESCRIPTION_PL, "UmieÅ˜a dany ciÅ}g znakow w buforze klawiatury."},
...
/* pl */ {IDGS_MON_PLAYBACK_DESCRIPTION_PL, "Polecenia monitora z podanego pliku sÅ} odczytywane i wykonywane.\nTa komenda zatrzymuje sie na koncu pliku, bÅ}d? przy odczycie komendy STOP."},
...
/* pl */ {IDGS_MON_PRINT_DESCRIPTION_PL, "Oszacuj okreÅ˜lone wyra?enie i podaj rezultat."},
...
/* pl */ {IDGS_MON_RECORD_DESCRIPTION_PL, "Po tym poleceniu wszystkie wprowadzone polecenia sÅ} zapisywane\ndo podanego pliku, poki nie zostanie wprowadzone polecenie STOP."},
...
/* pl */ {IDGS_MON_RESOURCEGET_DESCRIPTION_PL, "Pokazuje wartoÅ˜a zasobu"},
...
/* pl */ {IDGS_MON_RESOURCESET_DESCRIPTION_PL, "Ustawia wartoÅ˜a zasobu."},
...
/* pl */ {IDGS_MON_TAPECTRL_DESCRIPTION_PL, "Kontrola magnetofonu. W3aÅ˜ciwe polecenia:\n0 = stop, 1 = start, 2 = naprzod, 3 = przewin, 4 = nagrywaj,\n5 = reset, 6 = reset licznika."},
...
/* pl */ {IDCLS_ENABLE_AUTOSTART_HANDLE_TDE_PL, "W3Å}cz rzeczywistÅ} emulacje napedu przy autostarcie"},
...
/* pl */ {IDCLS_DISABLE_AUTOSTART_HANDLE_TDE_PL, "Nie w3Å}czaj rzeczywistej emulacji napedu przy autostarcie"},
...
/* pl */ {IDCLS_ENABLE_WARP_MODE_AUTOSTART_PL, "W3Å}cz tryb przyÅ˜pieszony podczas automatycznego startu"},
...
/* pl */ {IDCLS_DISABLE_WARP_MODE_AUTOSTART_PL, "Wy3Å}cz tryb przyÅ˜pieszony podczas automatycznego startu"},
...
/* pl */ {IDCLS_SET_AUTOSTART_MODE_FOR_PRG_PL, "OkreÅ˜l tryb autostartu z plikow PRG"},
...
/* pl */ {IDCLS_SET_DISK_IMAGE_FOR_AUTOSTART_PRG_PL, "OkreÅ˜l obraz dysku do autostartu z plikow PRG"},
...
/* pl */ {IDCLS_SET_AUTOSTART_DELAY_PL, "OkreÅ˜l poczÅ}tkowe opo?nienie autostartu (0: domyÅ˜lne)"},
...
/* pl */ {IDCLS_ENABLE_AUTOSTART_RANDOM_DELAY_PL, "W3Å}cz losowe opo?nienie na poczÅ}tku autostartu."},
...
/* pl */ {IDCLS_DISABLE_AUTOSTART_RANDOM_DELAY_PL, "Wy3Å}cz losowe opo?nienie na poczÅ}tku autostartu."},
...
/* pl */ {IDCLS_SPECIFY_INT_KERNEL_NAME_PL, "OkreÅ˜l nazwe obrazu miedzynarodowego ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_FI_KERNEL_NAME_PL, "OkreÅ˜l nazwe obrazu finskiego ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_FR_KERNEL_NAME_PL, "OkreÅ˜l nazwe obrazu francuskiego ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_IT_KERNEL_NAME_PL, "OkreÅ˜l nazwe obrazu w3oskiego ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_NO_KERNEL_NAME_PL, "OkreÅ˜l nazwe obrazu norweskiego ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_SV_KERNEL_NAME_PL, "OkreÅ˜l nazwe obrazu szwedzkiego ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_BASIC_ROM_NAME_LOW_PL, "OkreÅ˜l nazwe obrazu ROM BASIC (ni?sza partia)"},
...
/* pl */ {IDCLS_SPECIFY_BASIC_ROM_NAME_HIGH_PL, "OkreÅ˜l nazwe obrazu ROM BASIC (wy?sza partia)"},
...
/* pl */ {IDCLS_SPECIFY_INT_CHARGEN_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM generatora znakow miedzynarodowych"},
...
/* pl */ {IDCLS_SPECIFY_DE_CHARGEN_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM generatora niemieckich znakow"},
...
/* pl */ {IDCLS_SPECIFY_FR_CHARGEN_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM generatora francuskich znakow"},
...
/* pl */ {IDCLS_SPECIFY_SV_CHARGEN_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM generatora szwedzkich znakow"},
...
/* pl */ {IDCLS_SPECIFY_C64_MODE_KERNAL_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Kernala trybu C64"},
...
/* pl */ {IDCLS_SPECIFY_C64_MODE_BASIC_NAME_PL, "OkreÅ˜l nazwe obrazu ROM BASIC trybu C64"},
...
/* pl */ {IDCLS_ENABLE_OEM_JOY_PL, "W3Å}cz z3Å}cze OEM userportu joysticka"},
...
/* pl */ {IDCLS_DISABLE_OEM_JOY_PL, "Wy3Å}cz z3Å}cze OEM userportu joysticka"},
...
/* pl */ {IDCLS_ENABLE_IEE488_PL, "W3Å}cz emulacje interfejsu IEEE488"},
...
/* pl */ {IDCLS_DISABLE_IEE488_PL, "Wy3Å}cz emulacje interfejsu IEEE488"},
...
/* pl */ {IDCLS_ENABLE_DEXX_ACIA_RS232_EMU_PL, "W3Å}cz emulacje interfejsu ACIA RS232"},
...
/* pl */ {IDCLS_DISABLE_DEXX_ACIA_RS232_EMU_PL, "Wy3Å}cz emulacje interfejsu ACIA RS232"},
...
/* pl */ {IDCLS_ENABLE_ACIA_EMU_PL, "W3Å}cz emulacje ACIA"},
...
/* pl */ {IDCLS_DISABLE_ACIA_EMU_PL, "Wy3Å}cz emulacje ACIA"},
...
/* pl */ {IDCLS_SPECIFY_SYM_KEYMAP_FILE_NAME_PL, "OkreÅ˜l nazwe pliku symbolicznego uk3adu klawiatury"},
...
/* pl */ {IDCLS_SPECIFY_POS_KEYMAP_FILE_NAME_PL, "OkreÅ˜l nazwe pliku pozycyjnego uk3adu klawiatury"},
...
/* pl */ {IDCLS_ACTIVATE_40_COL_MODE_PL, "W3Å}cz tryb 40 kolumn"},
...
/* pl */ {IDCLS_ACTIVATE_80_COL_MODE_PL, "W3Å}cz tryb 80 kolumn"},
...
/* ko */ {IDCLS_GO64_MODE_KO, "ÅLU?A?AAUCIÅCe CÅ~Å‚o C64 ÅCdÉ a ÅEI 1U2oÅLIÅLU"},
/* nl */ {IDCLS_GO64_MODE_NL, "Start altijd op in C64 modus na reset"},
/* pl */ {IDCLS_GO64_MODE_PL, "Przy restarcie zawsze prze3Å}czaj w tryb C64"},
...
/* pl */ {IDCLS_GO128_MODE_PL, "Przy restarcie zawsze prze3Å}czaj w tryb C128"},
...
/* pl */ {IDCLS_SPECIFY_INT_FUNC_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Internal Function"},
...
/* pl */ {IDCLS_SPECIFY_EXT_FUNC_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM External Function"},
...
/* ko */ {IDCLS_ENABLE_INT_FUNC_ROM_KO, "AIAI3I Function ROM AÅ‚ Å‚c?eÅã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_ENABLE_INT_FUNC_ROM_NL, "Activeer de interne functie ROM"},
/* pl */ {IDCLS_ENABLE_INT_FUNC_ROM_PL, "W3Å}cz wewnetrznÅ} funkcje ROM"},
...
/* pl */ {IDCLS_DISABLE_INT_FUNC_ROM_PL, "Wy3Å}cz ROM Internal Function"},
...
/* ko */ {IDCLS_ENABLE_EXT_FUNC_ROM_KO, "?UoI Function ROM AÅ‚ Å‚c?eÅã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_ENABLE_EXT_FUNC_ROM_NL, "Activeer de externe functie ROM"},
/* pl */ {IDCLS_ENABLE_EXT_FUNC_ROM_PL, "W3Å}cz zewnetrznÅ} funkcje ROM"},
...
/* pl */ {IDCLS_DISABLE_EXT_FUNC_ROM_PL, "Wy3Å}cz ROM External Function"},
...
/* pl */ {IDCLS_SET_C64_MODEL_PL, "OkreÅ˜l model C64 (c64/c64c/c64old, ntsc/newntsc/oldntsc, drean)"},
...
/* pl */ {IDCLS_SPECIFY_KERNAL_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Kernala"},
...
/* pl */ {IDCLS_SPECIFY_BASIC_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu BASIC ROM"},
...
/* pl */ {IDCLS_SPECIFY_CHARGEN_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM-u tworzenia znakow"},
...
/* pl */ {IDCLS_SPECIFY_INDEX_KEYMAP_FILE_0_2_PL, "Podaj indeks dla uk3Å}du klawiatury (0=symbol, 1=symbolDE, 2=pozycja)"},
...
/* pl */ {IDCLS_SPECIFY_NAME_SYM_DE_KEYMAP_PL, "OkreÅ˜l nazwe pliku symbolicznego niemieckiego uk3adu klawiatury"},
...
/* pl */ {IDCLS_ENABLE_HUMMER_ADC_PL, "W3Å}cz Hummer ADC"},
...
/* pl */ {IDCLS_DISABLE_HUMMER_ADC_PL, "Wy3Å}cz Hummer ADC"},
...
/* pl */ {IDCLS_ENABLE_IEEE488_INTERFACE_PL, "W3Å}cz emulacje interfejsu IEEE488"},
...
/* pl */ {IDCLS_DISABLE_IEEE488_INTERFACE_PL, "Wy3Å}cz emulacje interfejsu IEEE488"},
...
/* pl */ {IDCLS_SPECIFY_IEEE488_INTERFACE_NAME_PL, "okreÅ˜l nazwe obrazu interfejsu IEEE488"},
...
/* pl */ {IDCLS_ENABLE_GEORAM_PL, "W3Å}cz jednostke rozszerzenia GEO-RAM"},
...
/* pl */ {IDCLS_DISABLE_GEORAM_PL, "Wy3Å}cz jednostke rozszerzenia GEO-RAM"},
...
/* pl */ {IDCLS_SPECIFY_GEORAM_NAME_PL, "OkreÅ˜l nazwe obrazu GEORAM"},
...
/* pl */ {IDCLS_ENABLE_PETREU_PL, "W3Å}cz PET Ram i Expansion Unit"},
...
/* pl */ {IDCLS_DISABLE_PETREU_PL, "Wy3Å}cz PET Ram i Expansion Unit"},
...
/* pl */ {IDCLS_SPECIFY_PETREU_NAME_PL, "OkreÅ˜l nazwe obrazu PET Ram i Expansion Unit"},
...
/* pl */ {IDCLS_SPECIFY_PETDWW_NAME_PL, "OkreÅ˜l nazwe obrazu PET DWW"},
...
/* pl */ {IDCLS_ENABLE_PETDWW_PL, "W3Å}cz uk3ad PET DWW hi-res"},
...
/* pl */ {IDCLS_DISABLE_PETDWW_PL, "Wy3Å}cz p3yte PET DWW hi-res"},
...
/* pl */ {IDCLS_ENABLE_USERPORT_DAC_PL, "W3Å}cz userport DAC jako wyjÅ˜cie d?wieku"},
...
/* pl */ {IDCLS_DISABLE_USERPORT_DAC_PL, "Wy3Å}cz userport DAC jako wyÅ˜cie d?wieku"},
...
/* pl */ {IDCLS_OVERWRITE_PSID_SETTINGS_PL, "ZastÅ}p ustawienia PSID standardu wideo i modelu SID"},
...
/* pl */ {IDCLS_SPECIFY_PSID_TUNE_NUMBER_PL, "OkreÅ˜l ton PSID <numer>"},
...
/* pl */ {IDCLS_ENABLE_RAMCART_PL, "W3Å}cz rozszerzenie RamCart"},
...
/* pl */ {IDCLS_DISABLE_RAMCART_PL, "Wy3Å}cz rozszerzenie Ram Cart"},
...
/* pl */ {IDCLS_SPECIFY_RAMCART_NAME_PL, "OkreÅ˜l nazwe obrazu RAMCART"},
...
/* pl */ {IDCLS_ENABLE_DQBB_PL, "W3Å}cz Double Quick Brown Box"},
...
/* pl */ {IDCLS_DISABLE_DQBB_PL, "Wy3Å}cz Double Quick Brown Box"},
...
/* pl */ {IDCLS_SPECIFY_DQBB_NAME_PL, "OkreÅ˜l nazwe pliku Double Quick Brown Box"},
...
/* pl */ {IDCLS_ENABLE_ISEPIC_PL, "W3Å}cz kartrid? ISEPIC"},
...
/* pl */ {IDCLS_DISABLE_ISEPIC_PL, "Wy3Å}cz kartrid? ISEPIC"},
...
/* pl */ {IDCLS_SET_ISEPIC_FILENAME_PL, "OkreÅ˜l nazwe obrazu ISEPIC"},
...
/* pl */ {IDCLS_ENABLE_MMC64_PL, "W3Å}cz rozszerzenie MMC64"},
...
/* pl */ {IDCLS_DISABLE_MMC64_PL, "Wy3Å}cz rozszerzenie MMC64"},
...
/* pl */ {IDCLS_SPECIFY_MMC64_BIOS_NAME_PL, "OkreÅ˜l nazwe obrazu BIOS MMC64"},
...
/* pl */ {IDCLS_SPECIFY_MMC64_IMAGE_NAME_PL, "OkreÅ˜l nazwe obrazu MMC64"},
...
/* pl */ {IDCLS_SELECT_MMC_REPLAY_CARD_IMAGE_FILENAME_PL, "OkreÅ˜l nazwe pliku obrazu karty MMC Replay"},
...
/* pl */ {IDCLS_MMC_REPLAY_CARD_WRITE_ENABLE_PL, "W3Å}cz zapis do obrazu karty MMC Replay"},
...
/* pl */ {IDCLS_MMC_REPLAY_CARD_WRITE_DISABLE_PL, "Wy3Å}cz zapis do obrazu karty MMC Replay"},
...
/* pl */ {IDCLS_SELECT_MMC_REPLAY_EEPROM_IMAGE_PL, "OkreÅ˜l nazwe pliku obrazu EEPROM MMC Replay"},
...
/* ko */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_ENABLE_KO, "MMC Replay EEPROM AI1IAo ?! ?2Å}a Åã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_ENABLE_NL, "Aktiveer schrijven naar MMC Replay EEPROM bestand"},
/* pl */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_ENABLE_PL, "W3Å}cz zapis do obrazu EEPROM MMC Replay"},
...
/* pl */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_DISABLE_PL, "Wy3Å}cz zapis do obrazu EEPROM MMC Replay"},
...
/* pl */ {IDCLS_MMC_REPLAY_RESCUE_MODE_ENABLE_PL, "W3Å}cz tryb ratunkowy MMC Replay"},
...
/* pl */ {IDCLS_MMC_REPLAY_RESCUE_MODE_DISABLE_PL, "Wy3Å}cz tryb ratunkowy MMC Replay"},
...
/* pl */ {IDCLS_ENABLE_SAVE_RR_ROM_AT_EXIT_PL, "W3Å}az zapis ROM RR przy wyjÅ˜ciu"},
...
/* pl */ {IDCLS_DISABLE_SAVE_RR_ROM_AT_EXIT_PL, "Wy3Å}az zapis ROM RR przy wyjÅ˜ciu"},
...
/* pl */ {IDCLS_SET_RR_BANK_JUMPER_PL, "Ustaw prze3Å}cznik RR Bank"},
...
/* pl */ {IDCLS_UNSET_RR_BANK_JUMPER_PL, "Wy3Å}cz prze3Å}cznik RR Bank"},
...
/* pl */ {IDCLS_SET_RR_FLASH_JUMPER_PL, "Ustaw prze3Å}cznik RR Flash"},
...
/* pl */ {IDCLS_UNSET_RR_FLASH_JUMPER_PL, "Wy3Å}cz prze3Å}cznik RR Bank"},
...
/* pl */ {IDCLS_ENABLE_REU_PL, "W3Å}cz RAM Expansion Unit"},
...
/* pl */ {IDCLS_DISABLE_REU_PL, "Wy3Å}cz RAM Expansion Unit"},
...
/* pl */ {IDCLS_SPECIFY_REU_NAME_PL, "OkreÅ˜l nazwe obrazu REU"},
...
/* pl */ {IDCLS_ENABLE_TFE_PL, "W3Å}cz jednostke TFE (\"The Final Ethernet\")"},
...
/* pl */ {IDCLS_DISABLE_TFE_PL, "Wy3Å}cz jednostke TFE (\"The Final Ethernet\")"},
...
/* pl */ {IDCLS_ENABLE_TFE_AS_RRNET_PL, "W3Å}cz tryb RRNet emulacji TFE"},
...
/* pl */ {IDCLS_DISABLE_TFE_AS_RRNET_PL, "Wy3Å}cz tryb RRNet emulacji TFE"},
...
/* ko */ {IDCLS_ATTACH_GENERIC_8KB_CART_KO, "8kb AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_GENERIC_16KB_CART_KO, "16kb AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_EASY_FLASH_CART_KO, "EasyFlash AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_RETRO_REPLAY_CART_KO, "64KB Retro Replay AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_IDE64_CART_KO, "64kb IDE64 AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_ATOMIC_POWER_CART_KO, "32kb Atomic Power AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_EPYX_FASTLOAD_CART_KO, "8kb Epyx FastLoad AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_SS5_CART_KO, "64KB Super Snapshot V5 AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_MAGIC_FORMEL_CART_KO, "Magic Formel AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* ko */ {IDCLS_ATTACH_RAW_MMC_REPLAY_CART_KO, "512KB MMC Replay AÅ·ARÅCRAo AI1IAoÅC| oUAI???a"},
...
/* pl */ {IDCLS_ENABLE_EXPERT_CART_PL, "W3Å}cz Expert Cartridge"},
...
/* pl */ {IDCLS_DISABLE_EXPERT_CART_PL, "Wy3Å}cz Expert Cartridge"},
...
/* pl */ {IDCLS_SET_EXPERT_FILENAME_PL, "OkreÅ˜l nazwe obrazu Expert Cartridge"},
...
/* pl */ {IDCLS_DISABLE_CART_PL, "Wy3Å}cz domyÅ˜lny kartrid?"},
...
/* ko */ {IDCLS_SMART_ATTACH_CART_KO, "AÅ·ARÅCRAo AI1IAoÅC| ?oÅCÅ˜AR-oUAIÅ}a CIÅ}a"},
...
/* pl */ {IDCLS_SPECIFY_IDE64_NAME_PL, "OkreÅ˜l nazwe pliku obrazu IDE64"},
...
/* pl */ {IDCLS_SPECIFY_CBM2_MODEL_PL, "OkreÅ˜l emulowany model CBM-II"},
...
/* pl */ {IDCLS_SPECIFY_TO_USE_VIC_II_PL, "OkreÅ˜l u?ycie VIC-II"},
...
/* pl */ {IDCLS_SPECIFY_TO_USE_CRTC_PL, "OkreÅ˜l u?ycie CRTC"},
...
/* pl */ {IDCLS_SPECIFY_CBM2_MODEL_HARDWARE_PL, "OkreÅ˜l model sprzetu CBM-II (0=6x0, 1=7x0)"},
...
/* pl */ {IDCLS_SPECIFY_SIZE_OF_RAM_PL, "OkreÅ˜l rozmiar RAM-u (64/128/256/512/1024 kBajty)"},
...
/* pl */ {IDCLS_SPECIFY_CART_ROM_1000_NAME_PL, "OkreÅ˜l nazwe obrazu ROM kartrid?a w $1000"},
...
/* pl */ {IDCLS_SPECIFY_CART_ROM_2000_NAME_PL, "OkreÅ˜l nazwe obrazu ROM kartrid?a w $2000-$3fff"},
...
/* pl */ {IDCLS_SPECIFY_CART_ROM_4000_NAME_PL, "OkreÅ˜l nazwe obrazu ROM kartrid?a w $4000-$5fff"},
...
/* pl */ {IDCLS_SPECIFY_CART_ROM_6000_NAME_PL, "OkreÅ˜l nazwe obrazu ROM kartrid?a w $6000-$7fff"},
...
/* pl */ {IDCLS_ENABLE_RAM_MAPPING_IN_0800_PL, "W3Å}cz mapowanie RAM w $0800-$0FFF"},
...
/* pl */ {IDCLS_DISABLE_RAM_MAPPING_IN_0800_PL, "Wy3Å}cz mapowanie RAM w $0800-$0FFF"},
...
/* pl */ {IDCLS_ENABLE_RAM_MAPPING_IN_1000_PL, "W3Å}cz mapowanie RAM w $1000-$1FFF"},
...
/* pl */ {IDCLS_DISABLE_RAM_MAPPING_IN_1000_PL, "Wy3Å}cz mapowanie RAM w $1000-$1FFF"},
...
/* pl */ {IDCLS_ENABLE_RAM_MAPPING_IN_2000_PL, "W3Å}cz mapowanie RAM w $2000-$3FFF"},
...
/* pl */ {IDCLS_DISABLE_RAM_MAPPING_IN_2000_PL, "Wy3Å}cz mapowanie RAM w $2000-$3FFF"},
...
/* pl */ {IDCLS_ENABLE_RAM_MAPPING_IN_4000_PL, "W3Å}cz mapowanie RAM w $4000-$5FFF"},
...
/* pl */ {IDCLS_DISABLE_RAM_MAPPING_IN_4000_PL, "Wy3Å}cz mapowanie RAM w $4000-$5FFF"},
...
/* pl */ {IDCLS_ENABLE_RAM_MAPPING_IN_6000_PL, "W3Å}cz mapowanie RAM w $6000-$7FFF"},
...
/* pl */ {IDCLS_DISABLE_RAM_MAPPING_IN_6000_PL, "Wy3Å}cz mapowanie RAM w $6000-$7FFF"},
...
/* pl */ {IDCLS_ENABLE_RAM_MAPPING_IN_C000_PL, "W3Å}cz mapowanie RAM w $C000-$CFFF"},
...
/* pl */ {IDCLS_DISABLE_RAM_MAPPING_IN_C000_PL, "Wy3Å}cz mapowanie RAM w $C000-$CFFF"},
...
/* pl */ {IDCLS_SPECIFY_KEYMAP_INDEX_PL, "OkreÅ˜l indeks pliku uk3adu klawiatury"},
...
/* pl */ {IDCLS_SPECIFY_GFX_SYM_KEYMAP_NAME_PL, "OkreÅ˜l nazwe pliku symbolicznego uk3adu klawiatury graficznej"},
...
/* pl */ {IDCLS_SPECIFY_GFX_POS_KEYMAP_NAME_PL, "OkreÅ˜l nazwe pliku pozycyjnego uk3adu klawiatury graficznej"},
...
/* pl */ {IDCLS_SPECIFY_BUK_SYM_KEYMAP_NAME_PL, "OkreÅ˜l nazwe pliku symbolicznego uk3adu angielskiej klawiatury biznesowej"},
...
/* pl */ {IDCLS_SPECIFY_BUK_POS_KEYMAP_NAME_PL, "OkreÅ˜l nazwe pliku pozycyjnego uk3adu angielskiej klawiatury biznesowej"},
...
/* pl */ {IDCLS_SPECIFY_BDE_SYM_KEYMAP_NAME_PL, "OkreÅ˜l nazwe pliku symbolicznego uk3adu niemieckiej klawiatury biznesowej"},
...
/* pl */ {IDCLS_SPECIFY_BDE_POS_KEYMAP_NAME_PL, "OkreÅ˜l nazwe pliku pozycyjnego uk3adu niemieckiej klawiatury biznesowej"},
...
/* pl */ {IDCLS_ENABLE_TRUE_DRIVE_PL, "W3Å}cz sprzetowÅ} emulacje stacji dyskow"},
...
/* pl */ {IDCLS_DISABLE_TRUE_DRIVE_PL, "Wy3Å}cz sprzetowÅ} emulacje stacji dyskow"},
...
/* pl */ {IDCLS_OVERSIZED_HANDLING_PL, "Wybierz sposob, w jaki ma bya obs3ugiwany za du?y obraz, (0: zmniejszenie, 1: Å˜ciecie z gory z lewej, 2: Å˜ciecie z gory, 3: Å˜ciecie z prawej z gory, 4: Å˜ciecie z lewej, 5: Å˜ciecie od Å˜rodka, 6: Å˜ciecie z prawej, 7: Å˜ciecie z lewej z do3u, 8: Å˜ciecie z do3u, 9: Å˜ciecie z prawej z do3u)"},
...
/* pl */ {IDCLS_MULTICOLOR_HANDLING_PL, "Wybiera sposob obs3ugi multikoloru do hires (0: czarno-bia3y, 1: 2 kolory, 2: 4 kolory, 3: skala szaroÅ˜ci, 4: najlepsze kolory komorek)"},
...
/* pl */ {IDCLS_TED_LUM_HANDLING_PL, "Wybor sposobu obs3ugi jaskrawoÅ˜ci TED (0: ignoruj, 1: ditheruj)"},
...
/* pl */ {IDCLS_SET_DRIVE_EXTENSION_POLICY_PL, "OkreÅ˜l zasade rozszerzania do 40 Å˜cie?ek (0: nigdy, 1: pytaj, 2: przy dostepie)"},
...
/* pl */ {IDCLS_SPECIFY_1541_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1541 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_1541_II_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1541-II DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_1570_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1570 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_1571_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1571 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_1581_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1581 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_2000_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 2000 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_4000_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 4000 DOS ROM"},
...
/* pl */ {IDCLS_SET_IDLE_METHOD_PL, "OkreÅ˜l metode bezczynnoÅ˜ci napedu (0: no traps, 1: opuszczaj cykle, 2: trap idle)"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_RAM_2000_PL, "W3Å}cz rozszerzenie 8KB RAM w $2000-$3FFF"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_RAM_2000_PL, "Wy3Å}cz rozszerzenie 8KB RAM w $2000-$3FFF"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_RAM_4000_PL, "W3Å}cz rozszerzenie 8KB RAM w $4000-$5FFF"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_RAM_4000_PL, "Wy3Å}cz rozszerzenie 8KB RAM w $4000-$5FFF"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_RAM_6000_PL, "W3Å}cz rozszerzenie 8KB RAM w $6000-$7FFF"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_RAM_6000_PL, "Wy3Å}cz rozszerzenie 8KB RAM w $6000-$7FFF"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_RAM_8000_PL, "W3Å}cz rozszerzenie 8KB RAM w $8000-$9FFF"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_RAM_8000_PL, "Wy3Å}cz rozszerzenie 8KB RAM w $8000-$9FFF"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_RAM_A000_PL, "W3Å}cz rozszerzenie 8KB RAM w $A000-$BFFF"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_RAM_A000_PL, "Wy3Å}cz rozszerzenie 8KB RAM w $A000-$BFFF"},
...
/* pl */ {IDCLS_PAR_CABLE_C64EXP_TYPE_PL, "OkreÅ˜l typ 3Å}cza rownoleg3ego (0: brak, 1: zwyk3e, 2: Dolphin DOS 3)"},
...
/* pl */ {IDCLS_ENABLE_PROFDOS_PL, "W3Å}cz Professional DOS"},
...
/* pl */ {IDCLS_DISABLE_PROFDOS_PL, "Wy3Å}cz Professional DOS"},
...
/* pl */ {IDCLS_SPECIFY_PROFDOS_1571_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Professional DOS 1571"},
...
/* pl */ {IDCLS_SPECIFY_1571CR_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1571CR DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_2031_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 2031 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_2040_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 2040 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_3040_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 3040 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_4040_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 4040 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_1001_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1001/8050/8250 DOS ROM"},
...
/* pl */ {IDCLS_SPECIFY_1551_DOS_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu 1551 DOS ROM"},
...
/* pl */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_8_PL, "Uzyj <nazwa> jako katalog urzÅ}dzenia systemu plikow #8"},
...
/* pl */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_9_PL, "Uzyj <nazwa> jako katalog urzÅ}dzenia systemu plikow #9"},
...
/* pl */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_10_PL, "Uzyj <nazwa> jako katalog urzÅ}dzenia systemu plikow #10"},
...
/* pl */ {IDCLS_USE_AS_DIRECTORY_FSDEVICE_11_PL, "Uzyj <nazwa> jako katalog urzÅ}dzenia systemu plikow #11"},
...
/* pl */ {IDCLS_SET_AUDIO_STREAM_BITRATE_PL, "OkreÅ˜l szybkoÅ˜a transmisji strumienia audio w pliku multimediow"},
...
/* pl */ {IDCLS_SET_VIDEO_STREAM_BITRATE_PL, "OkreÅ˜l szybkoÅ˜a transmisji strumienia wideo w pliku multimediow"},
...
/* pl */ {IDCLS_SPECIFY_PET_MODEL_PL, "OkreÅ˜l emulowany model PET"},
...
/* pl */ {IDCLS_SPECIFY_EDITOR_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Editor"},
...
/* pl */ {IDCLS_SPECIFY_4K_ROM_9XXX_NAME_PL, "OkreÅ˜l nazwe rozszerzenia 4K ROM w $9***"},
...
/* pl */ {IDCLS_SPECIFY_4K_ROM_AXXX_NAME_PL, "OkreÅ˜l nazwe rozszerzenia 4K ROM w $A***"},
...
/* pl */ {IDCLS_SPECIFY_4K_ROM_BXXX_NAME_PL, "OkreÅ˜l nazwe rozszerzenia 4K ROM w $B***"},
...
/* pl */ {IDCLS_PET8296_ENABLE_4K_RAM_AT_9000_PL, "W3Å}cz mapowanie 4K RAM PET8296 w $9***"},
...
/* pl */ {IDCLS_PET8296_DISABLE_4K_RAM_AT_9000_PL, "Wy3Å}cz mapowanie 4K RAM PET8296 w $9***"},
...
/* pl */ {IDCLS_PET8296_ENABLE_4K_RAM_AT_A000_PL, "W3Å}cz mapowanie 4K RAM PET8296 w $A***"},
...
/* pl */ {IDCLS_PET8296_DISABLE_4K_RAM_AT_A000_PL, "Wy3Å}cz mapowanie 4K RAM PET8296 w $A***"},
...
/* pl */ {IDCLS_ENABLE_SUPERPET_IO_PL, "W3Å}cz we/wy SuperPET"},
...
/* pl */ {IDCLS_DISABLE_SUPERPET_IO_PL, "Wy3Å}cz we/wy SuperPET"},
...
/* pl */ {IDCLS_ENABLE_ROM_1_KERNAL_PATCHES_PL, "W3Å}cz 3atki ROM 1 Kernala"},
...
/* pl */ {IDCLS_DISABLE_ROM_1_KERNAL_PATCHES_PL, "W3Å}cz 3atki ROM 1 Kernala"},
...
/* pl */ {IDCLS_SWITCH_UPPER_LOWER_CHARSET_PL, "Prze3Å}cz zestaw wielkich/ma3ych znakow"},
...
/* pl */ {IDCLS_NO_SWITCH_UPPER_LOWER_CHARSET_PL, "Nie prze3Å}czaj zestawu wielkich/ma3ych znakow"},
...
/* pl */ {IDCLS_EOI_BLANKS_SCREEN_PL, "Koniec przerwania czyÅ˜ci ekran"},
...
/* pl */ {IDCLS_EOI_DOES_NOT_BLANK_SCREEN_PL, "Koniec przerwania nie czyÅ˜ci ekranu"},
...
/* pl */ {IDCLS_ENABLE_USERPORT_DIAG_PIN_PL, "W3Å}cz pin diagnostyczny userportu"},
...
/* pl */ {IDCLS_DISABLE_USERPORT_DIAG_PIN_PL, "Wy3Å}cz pin diagnostyczny userportu"},
...
/* pl */ {IDCLS_SPECIFY_FUNCTION_LOW_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Function low"},
...
/* pl */ {IDCLS_SPECIFY_FUNCTION_HIGH_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Function high"},
...
/* pl */ {IDCLS_SPECIFY_CART_1_LOW_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Cartridge 1 low"},
...
/* pl */ {IDCLS_SPECIFY_CART_1_HIGH_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Cartridge 1 high"},
...
/* pl */ {IDCLS_SPECIFY_CART_2_LOW_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Cartridge 2 low"},
...
/* pl */ {IDCLS_SPECIFY_CART_2_HIGH_ROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM Cartridge 2 high"},
...
/* pl */ {IDCLS_SPECIFY_RAM_INSTALLED_PL, "OkreÅ˜l iloÅ˜a zainstalowanego RAM-u w kb (16/32/64)"},
...
/* pl */ {IDCLS_SET_SATURATION_PL, "OkreÅ˜l nasycenie wewnetrznie obliczonej palety kolorystycznej [1000]"},
...
/* pl */ {IDCLS_SET_CONTRAST_PL, "OkreÅ˜l kontrast wewnetrznie obliczonej palety kolorystycznej [1000]"},
...
/* pl */ {IDCLS_SET_BRIGHTNESS_PL, "OkreÅ˜l jasnoÅ˜a wewnetrznie obliczonej palety kolorystycznej [1000]"},
...
/* pl */ {IDCLS_SET_GAMMA_PL, "OkreÅ˜l jaskrawoÅ˜a wewnetrznie obliczonej palety kolorystycznej [1000]"},
...
/* pl */ {IDCLS_SET_TINT_PL, "OkreÅ˜l odcien wewnetrznie obliczonej palety kolorystycznej [1000]"},
...
/* pl */ {IDCLS_SET_ODDLINES_PHASE_PL, "OkreÅ˜l faze noÅ˜nika koloru w liniach nieparzystych [1250]"},
...
/* pl */ {IDCLS_SET_ODDLINES_OFFSET_PL, "OkreÅ˜l wyrownanie fazy noÅ˜nika koloru w liniach nieparzystych [750]"},
...
/* pl */ {IDCLS_SPECIFY_PRT_DRIVER_4_NAME_PL, "OkreÅ˜l nazwe sterownika drukarki urzÅ}dzenia #4"},
...
/* pl */ {IDCLS_SPECIFY_PRT_DRIVER_5_NAME_PL, "OkreÅ˜l nazwe sterownika drukarki urzÅ}dzenia #5"},
...
/* pl */ {IDCLS_SPECIFY_PRT_DRIVER_USR_NAME_PL, "OkreÅ˜l nazwe sterownika drukarki dla drukarki w userporcie"},
...
/* pl */ {IDCLS_SET_DEVICE_TYPE_4_PL, "OkreÅ˜l typ urzÅ}dzenia #4 (0: BRAK, 1: SYSTEM PLIKOW, 2: RZECZYWISTE)"},
...
/* pl */ {IDCLS_SET_DEVICE_TYPE_5_PL, "OkreÅ˜l typ urzÅ}dzenia #5 (0: BRAK, 1: SYSTEM PLIKOW, 2: RZECZYWISTE)"},
...
/* pl */ {IDCLS_ENABLE_USERPORT_PRINTER_PL, "W3Å}cz emulacje drukarki w userporcie"},
...
/* pl */ {IDCLS_DISABLE_USERPORT_PRINTER_PL, "Wy3Å}cz emulacje drukarki w userporcie"},
...
/* pl */ {IDCLS_SPECIFY_OUTPUT_DEVICE_4_NAME_PL, "OkreÅ˜l nazwe urzÅ}dzenia wyjÅ˜cia #4"},
...
/* pl */ {IDCLS_SPECIFY_OUTPUT_DEVICE_5_NAME_PL, "OkreÅ˜l nazwe urzÅ}dzenia wyjÅ˜cia #5"},
...
/* pl */ {IDCLS_SPECIFY_OUTPUT_DEVICE_USR_NAME_PL, "OkreÅ˜l nazwe urzÅ}dzenia wyjÅ˜ciowego dla drukarki w userporcie"},
...
/* pl */ {IDCLS_SPECIFY_TEXT_DEVICE_DUMP_NAME_PL, "OkreÅ˜l nazwe urzÅ}dzenia tekstowego drukarki lub pliku zrzutu"},
...
/* pl */ {IDCLS_SPECIFY_TEXT_DEVICE_4_PL, "OkreÅ˜l urzÅ}dzenie wyjÅ˜cia tekstowego drukarki #4"},
...
/* pl */ {IDCLS_SPECIFY_TEXT_DEVICE_5_PL, "OkreÅ˜l urzÅ}dzenie wyjÅ˜cia tekstowego drukarki #5"},
...
/* pl */ {IDCLS_SPECIFY_TEXT_USERPORT_PL, "OkreÅ˜l urzÅ}dzenie wyjÅ˜cia tekstu dla drukarki w userporcie"},
...
/* pl */ {IDCLS_ENABLE_VIDEO_CACHE_PL, "W3Å}cz cache wideo"},
...
/* pl */ {IDCLS_SPECIFY_RS232_1_NAME_PL, "OkreÅ˜l nazwe pierwszego urzÅ}dzenia RS232"},
...
/* pl */ {IDCLS_SPECIFY_RS232_2_NAME_PL, "OkreÅ˜l nazwe drugiego urzÅ}dzenia RS232"},
...
/* pl */ {IDCLS_SPECIFY_RS232_3_NAME_PL, "OkreÅ˜l nazwe trzeciego urzÅ}dzenia RS232"},
...
/* pl */ {IDCLS_SPECIFY_RS232_4_NAME_PL, "OkreÅ˜l nazwe czwartego urzÅ}dzenia RS232"},
...
/* pl */ {IDCLS_ENABLE_RS232_USERPORT_PL, "W3Å}cz emulacje userportu RS232"},
...
/* pl */ {IDCLS_DISABLE_RS232_USERPORT_PL, "Wy3Å}cz emulacje userportu RS232"},
...
/* pl */ {IDCLS_SET_BAUD_RS232_USERPORT_PL, "OkreÅ˜l predkoÅ˜a transmisji emulacji userportu RS232."},
...
/* pl */ {IDCLS_SPECIFY_RS232_DEVICE_USERPORT_PL, "OkreÅ˜l urzÅ}dzenie VICE RS232 w userporcie"},
...
/* pl */ {IDCLS_ENABLE_IEC_4_PL, "W3Å}cz emulacje IEC urzÅ}dzenia #4"},
...
/* pl */ {IDCLS_DISABLE_IEC_4_PL, "Wy3Å}cz emulacje urzÅ}dzenia IEC dla urzÅ}dzenia #4"},
...
/* pl */ {IDCLS_ENABLE_IEC_5_PL, "W3Å}cz emulacje IEC urzÅ}dzenia #5"},
...
/* pl */ {IDCLS_DISABLE_IEC_5_PL, "Wy3Å}cz emulacje urzÅ}dzenia IEC dla urzÅ}dzenia #5"},
...
/* pl */ {IDCLS_ENABLE_IEC_8_PL, "W3Å}cz emulacje IEC urzÅ}dzenia #8"},
...
/* pl */ {IDCLS_DISABLE_IEC_8_PL, "Wy3Å}cz emulacje urzÅ}dzenia IEC dla urzÅ}dzenia #8"},
...
/* pl */ {IDCLS_ENABLE_IEC_9_PL, "W3Å}cz emulacje IEC urzÅ}dzenia #9"},
...
/* pl */ {IDCLS_DISABLE_IEC_9_PL, "Wy3Å}cz emulacje urzÅ}dzenia IEC dla urzÅ}dzenia #9"},
...
/* pl */ {IDCLS_ENABLE_IEC_10_PL, "W3Å}cz emulacje IEC urzÅ}dzenia #10"},
...
/* pl */ {IDCLS_DISABLE_IEC_10_PL, "Wy3Å}cz emulacje urzÅ}dzenia IEC dla urzÅ}dzenia #10"},
...
/* pl */ {IDCLS_ENABLE_IEC_11_PL, "W3Å}cz emulacje IEC urzÅ}dzenia #11"},
...
/* pl */ {IDCLS_DISABLE_IEC_11_PL, "Wy3Å}cz emulacje urzÅ}dzenia IEC dla urzÅ}dzenia #11"},
...
/* pl */ {IDCLS_ENABLE_SECOND_SID_PL, "W3Å}cz drugi SID"},
...
/* pl */ {IDCLS_ENABLE_SIDCART_PL, "W3Å}cz kartrid? SID"},
...
/* pl */ {IDCLS_DISABLE_SIDCART_PL, "Wy3Å}cz kartrid? SID"},
...
/* pl */ {IDCLS_SPECIFY_SID_2_ADDRESS_PL, "OkreÅ˜l adres bazowy drugiego SID-a"},
...
/* pl */ {IDCLS_PASSBAND_PERCENTAGE_PL, "Pasmo resamplowania reSID w procentach ca3kowitej przepustowoÅ˜ai (0 - 90)"},
...
/* pl */ {IDCLS_ENABLE_STRETCH_VERTICAL_PL, "W3Å}cz dodatkowe rozciÅ}ganie w pionie"},
...
/* pl */ {IDCLS_DISABLE_STRETCH_VERTICAL_PL, "Wy3Å}cz dodatkowe rozciÅ}ganie w pionie"},
...
/* pl */ {IDCLS_SET_VDC_REVISION_PL, "OkreÅ˜l wersje VDC (0..2)"},
...
/* pl */ {IDCLS_SPECIFY_MEMORY_CONFIG_PL, "OkreÅ˜l konfiguracje pamieci"},
...
/* pl */ {IDCLS_ENABLE_VIC1112_IEEE488_PL, "W3Å}cz interfejs IEEE488 VIC-1112"},
...
/* pl */ {IDCLS_DISABLE_VIC1112_IEEE488_PL, "Wy3Å}cz interfejs IEEE488 VIC-1112"},
...
/* pl */ {IDCLS_SPECIFY_EXT_ROM_2000_NAME_PL, "OkreÅ˜l nazwe ROM rozszerzenia 4/8/16K w $2000"},
...
/* pl */ {IDCLS_SPECIFY_EXT_ROM_4000_NAME_PL, "OkreÅ˜l nazwe ROM rozszerzenia 4/8/16K w $4000"},
...
/* pl */ {IDCLS_SPECIFY_EXT_ROM_6000_NAME_PL, "OkreÅ˜l nazwe ROM rozszerzenia 4/8/16K w $6000"},
...
/* pl */ {IDCLS_SPECIFY_EXT_ROM_A000_NAME_PL, "OkreÅ˜l nazwe ROM rozszerzenia 4/8/16K w $A000"},
...
/* pl */ {IDCLS_SPECIFY_EXT_ROM_B000_NAME_PL, "OkreÅ˜l nazwe ROM rozszerzenia 4/8/16K w $B000"},
...
/* pl */ {IDCLS_SPECIFY_GENERIC_ROM_NAME_PL, "OkreÅ˜l nazwe typowego ROM-u rozszerzen"},
...
/* pl */ {IDCLS_SPECIFY_MEGA_CART_ROM_NAME_PL, "OkreÅ˜l nazwe ROM rozszerzenia Mega-Cart"},
...
/* pl */ {IDCLS_SPECIFY_FINAL_EXPANSION_ROM_NAME_PL, "OkreÅ˜l nazwe rozszerzenia ROM Final Expansion"},
...
/* pl */ {IDCLS_SPECIFY_VIC_FP_ROM_NAME_PL, "OkreÅ˜l nazwe rozszerzenia ROM Vic Flash Plugin"},
...
/* pl */ {IDCLS_ENABLE_FINALEXPANSION_WRITEBACK_PL, "W3Å}cz zapis do pliku ROM Final Expansion"},
...
/* pl */ {IDCLS_DISABLE_FINALEXPANSION_WRITEBACK_PL, "Wy3Å}cz zapis do pliku ROM Final Expansion"},
...
/* pl */ {IDCLS_SET_MEGACART_NVRAM_NAME_PL, "OkreÅ˜l nazwe pliku NvRAM Mega-Cart"},
...
/* pl */ {IDCLS_ENABLE_MEGACART_NVRAM_WRITE_PL, "W3Å}cz zapis do NvRAM Mega-Cart"},
...
/* pl */ {IDCLS_DISABLE_MEGACART_NVRAM_WRITE_PL, "Wy3Å}cz zapis do NvRAM Mega-Cart"},
...
/* pl */ {IDCLS_ENABLE_VICFP_ROM_WRITE_PL, "W3Å}cz zapis do pliku ROM Vic Flash Plugin"},
...
/* pl */ {IDCLS_DISABLE_VICFP_ROM_WRITE_PL, "Wy3Å}cz zapis do pliku ROM Vic Flash Plugin"},
...
/* pl */ {IDCLS_SET_BORDER_MODE_PL, "OkreÅ˜l tryb wyÅ˜wietlania ramki VIC-II (0: zwyk3a, 1: pe3na, 2: debug)"},
...
/* pl */ {IDCLS_ENABLE_SPRITE_BACKGROUND_PL, "W3Å}cz rejestry kolizji duszkow z t3em"},
...
/* pl */ {IDCLS_DISABLE_SPRITE_BACKGROUND_PL, "Wy3Å}cz rejestry kolizji duszkow z t3em"},
...
/* pl */ {IDCLS_ENABLE_SPRITE_SPRITE_PL, "W3Å}cz rejestry kolizji duszkow"},
...
/* pl */ {IDCLS_DISABLE_SPRITE_SPRITE_PL, "Wy3Å}cz rejestry kolizji duszkow"},
...
/* pl */ {IDCLS_USE_NEW_LUMINANCES_PL, "U?yj nowego typu jaskrawoÅ˜ci"},
...
/* pl */ {IDCLS_USE_OLD_LUMINANCES_PL, "U?yj starego typu jaskrawoÅ˜ci"},
...
/* pl */ {IDCLS_ENABLE_DOUBLE_SIZE_PL, "W3Å}cz podwojny rozmiar"},
...
/* pl */ {IDCLS_DISABLE_DOUBLE_SIZE_PL, "Wy3Å}cz podwojny rozmiar"},
...
/* pl */ {IDCLS_ENABLE_DOUBLE_SCAN_PL, "W3Å}cz podwojne skanowanie"},
...
/* pl */ {IDCLS_DISABLE_DOUBLE_SCAN_PL, "Wy3Å}cz podwojne skanowanie"},
...
/* pl */ {IDCLS_ENABLE_HARDWARE_SCALING_PL, "y3Å}cz skalowanie sprzetowe"},
...
/* pl */ {IDCLS_DISABLE_HARDWARE_SCALING_PL, "Wy3Å}cz skalowanie sprzetowe"},
...
/* pl */ {IDCLS_SPECIFY_EXTERNAL_PALETTE_NAME_PL, "OkreÅ˜l nazwe pliku zewnetrznej palety barw"},
...
/* pl */ {IDCLS_SELECT_FULLSCREEN_DEVICE_PL, "Wybierz urzÅ}dzenie pe3nego ekranu"},
...
/* pl */ {IDCLS_SPECIFY_ACIA_RS232_DEVICE_PL, "OkreÅ˜l urzÅ}dzenie RS232, na ktorym ma dzia3aa ACIA"},
...
/* pl */ {IDCLS_SET_DEVICE_TYPE_8_PL, "OkreÅ˜l typ urzÅ}dzenia #8 (0: NONE, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* pl */ {IDCLS_SET_DEVICE_TYPE_9_PL, "OkreÅ˜l typ urzÅ}dzenia #8 (0: NONE, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* pl */ {IDCLS_SET_DEVICE_TYPE_10_PL, "OkreÅ˜l typ urzÅ}dzenia #8 (0: NONE, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* pl */ {IDCLS_SET_DEVICE_TYPE_11_PL, "OkreÅ˜l typ urzÅ}dzenia #8 (0: NONE, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* pl */ {IDCLS_ENABLE_AUTO_DATASETTE_RESET_PL, "W3Å}cz automatyczny reset magnetofonu"},
...
/* pl */ {IDCLS_DISABLE_AUTO_DATASETTE_RESET_PL, "Wy3Å}cz automatyczny reset magnetofonu"},
...
/* pl */ {IDCLS_SET_ZERO_TAP_DELAY_PL, "OkreÅ˜l opo?nienie cyklow dla poczÅ}tku taÅ˜my"},
...
/* pl */ {IDCLS_SET_CYCLES_ADDED_GAP_TAP_PL, "OkreÅ˜l liczbe cyklow dodanych do ka?dej przerwy w taÅ˜mie"},
...
/* pl */ {IDCLS_DONT_TRACE_MAIN_CPU_PL, "Bez Å˜ledzenia g3ownego CPU"},
...
/* pl */ {IDCLS_DONT_TRACE_DRIVE0_CPU_PL, "Bez Å˜ledzenia CPU stacji0"},
...
/* pl */ {IDCLS_DONT_TRACE_DRIVE1_CPU_PL, "Bez Å˜ledzenia CPU stacji1"},
...
/* pl */ {IDCLS_DONT_TRACE_DRIVE2_CPU_PL, "Bez Å˜ledzenia CPU stacji2"},
...
/* pl */ {IDCLS_DONT_TRACE_DRIVE3_CPU_PL, "Bez Å˜ledzenia CPU stacji3"},
...
/* pl */ {IDCLS_TRACE_MODE_PL, "Tryb Å˜ledzenia (0=zwyk3e 1=ma3e 2=w historii)"},
...
/* pl */ {IDCLS_SET_INITIAL_BREAKPOINT_PL, "OkreÅ˜l poczÅ}tkowy punkt wstrzymania w monitorze"},
...
/* pl */ {IDCLS_ENABLE_REMOTE_MONITOR_PL, "W3Å}cz zdalny monitor"},
...
/* pl */ {IDCLS_DISABLE_REMOTE_MONITOR_PL, "Wy3Å}cz zdalny monitor"},
...
/* pl */ {IDCLS_REMOTE_MONITOR_ADDRESS_PL, "Lokalny adres, z ktorym ma sie po3Å}czya zdalny monitor"},
...
/* pl */ {IDCLS_SPECIFY_FLIP_LIST_NAME_PL, "OkreÅ˜l nazwe pliku obrazu listy podmiany noÅ˜nikow"},
...
/* pl */ {IDCLS_DONT_CALL_EXCEPTION_HANDLER_PL, "Nie zajmuj sie wyjÅ}tkami"},
...
/* pl */ {IDCLS_CALL_EXCEPTION_HANDLER_PL, "Zajmij sie wyjÅ}tkami (domyÅ˜lnie)"},
...
/* ko */ {IDCLS_RESTORE_DEFAULT_SETTINGS_KO, "É dAuAR ?3A? o1?o?AAÅãÅ}a"},
/* nl */ {IDCLS_RESTORE_DEFAULT_SETTINGS_NL, "Herstel standaard instellingen"},
/* pl */ {IDCLS_RESTORE_DEFAULT_SETTINGS_PL, "Przywroa domyÅ˜lne ustawienia"},
...
/* pl */ {IDCLS_SPECIFY_CONFIG_FILE_PL, "OkreÅ˜l plik konfiguracji"},
...
/* pl */ {IDCLS_ATTACH_AND_AUTOSTART_PL, "Zamontuj i automatycznie uruchom obraz taÅ˜my lub dysku <nazwa>"},
...
/* pl */ {IDCLS_ATTACH_AND_AUTOLOAD_PL, "Zamontuj i automatycznie wczytaj obraz taÅ˜my lub dysku <nazwa>"},
...
/* pl */ {IDCLS_ATTACH_AS_TAPE_PL, "Zamontuj <nazwa> jako obraz taÅ˜my"},
...
/* pl */ {IDCLS_PUT_STRING_INTO_KEYBUF_PL, "UmieÅ˜a dany ciÅ}g znakow w buforze klawiatury."},
...
/* pl */ {IDCLS_SPECIFY_LOG_FILE_NAME_PL, "OkreÅ˜l nazwe pliku z logiem"},
...
/* pl */ {IDCLS_ENABLE_VERBOSE_LOG_OUTPUT_PL, "W3Å}cz drobiazgowy zapis do loga."},
...
/* ko */ {IDCLS_ENABLE_MOUSE_GRAB_KO, "ÅCÅ˜?i?o Å}Å~ÅE| Åã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_ENABLE_MOUSE_GRAB_NL, "Gebruiken van de muis inschakelen"},
/* pl */ {IDCLS_ENABLE_MOUSE_GRAB_PL, "W3Å}cz przechwytywanie myszy"},
...
/* pl */ {IDCLS_DISABLE_MOUSE_GRAB_PL, "Wy3Å}cz przechwytywanie myszy"},
...
/* pl */ {IDCLS_SELECT_MOUSE_JOY_PORT_PL, "Wybierz port joysticka, do ktorego pod3Å}czona jest mysz"},
...
/* pl */ {IDCLS_ENABLE_PS2MOUSE_PL, "W3Å}cz mysz PS/2 w userporcie"},
...
/* pl */ {IDCLS_DISABLE_PS2MOUSE_PL, "Wy3Å}cz mysz PS/2 w userporcie"},
...
/* pl */ {IDCLS_SET_FIRST_RAM_ADDRESS_VALUE_PL, "OkreÅ˜l wartoÅ˜a pierwszego adresu RAM po uruchomieniu"},
...
/* pl */ {IDCLS_LENGTH_BLOCK_SAME_VALUE_PL, "D3ugoÅ˜a bloku pamieci zainicjowanego z tÅ} samÅ} wartoÅ˜ciÅ}"},
...
/* pl */ {IDCLS_LENGTH_BLOCK_SAME_PATTERN_PL, "D3ugoÅ˜a bloku pamieci zainicjowanego z tym samym wzorcem"},
...
/* ko */ {IDCLS_ENABLE_SOUND_PLAYBACK_KO, "Å‚c?iÉ a CAÅE1AI1e AÅ‚ Å‚c?eÅã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_ENABLE_SOUND_PLAYBACK_NL, "Activeer geluidsweergave"},
/* pl */ {IDCLS_ENABLE_SOUND_PLAYBACK_PL, "W3Å}cz d?wiek"},
...
/* pl */ {IDCLS_DISABLE_SOUND_PLAYBACK_PL, "Wy3Å}cz odtwarzanie d?wieku"},
...
/* pl */ {IDCLS_SET_SAMPLE_RATE_VALUE_HZ_PL, "Ustaw probkowanie sampli na <wartoÅ˜a> Hz"},
...
/* pl */ {IDCLS_SET_SOUND_BUFFER_SIZE_MSEC_PL, "Ustaw rozmiar bufora d?wieku na <wartoÅ˜a> ms"},
...
/* pl */ {IDCLS_SET_SOUND_FRAGMENT_SIZE_PL, "Ustaw rozmiar fragmentu d?wieku (0 = ma3y, 1 = Å˜redni, 2 = du?y)"},
...
/* pl */ {IDCLS_SPECIFY_SOUND_DRIVER_PL, "OkreÅ˜l sterownik d?wieku"},
...
/* pl */ {IDCLS_SPECIFY_SOUND_DRIVER_PARAM_PL, "OkreÅ˜l parametry inicjalizacji sterownika d?wieku"},
...
/* pl */ {IDCLS_SPECIFY_RECORDING_SOUND_DRIVER_PL, "OkreÅ˜l sterownik zapisu d?wieku"},
...
/* pl */ {IDCLS_SPECIFY_REC_SOUND_DRIVER_PARAM_PL, "OkreÅ˜l parametry inicjalizacji sterownika zapisu d?wieku"},
...
/* pl */ {IDCLS_SET_SOUND_SPEED_ADJUST_PL, "Ustaw dopasowanie predkoÅ˜ci d?wieku (0: elastyczne, 1: dopasowane, 2: dok3adne)"},
...
/* pl */ {IDCLS_DEFINE_SYSTEM_FILES_PATH_PL, "Definiuj Å˜cie?ke wyszukiwania plikow systemowych"},
...
/* pl */ {IDCLS_ENABLE_TRAPS_FAST_EMULATION_PL, "W3Å}cz mechanizm szybkiej emulacji dysku i taÅ˜my"},
...
/* pl */ {IDCLS_DISABLE_TRAPS_FAST_EMULATION_PL, "Wy3Å}cz mechanizm szybkiej emulacji dysku i taÅ˜my"},
...
/* pl */ {IDCLS_LIMIT_SPEED_TO_VALUE_PL, "Ograniczaj predkoÅ˜a emulacji do podanej wartoÅ˜ci"},
...
/* pl */ {IDCLS_UPDATE_EVERY_VALUE_FRAMES_PL, "Aktualizuj co <wartoÅ˜a> klatek (`0' - automatycznie)"},
...
/* ko */ {IDCLS_ENABLE_WARP_MODE_KO, "?uCA ÅCdÉ a Å‚c?eÅã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_ENABLE_WARP_MODE_NL, "Activeer warpmodus"},
/* pl */ {IDCLS_ENABLE_WARP_MODE_PL, "W3Å}cz tryb przyÅ˜pieszony (Turbo)"},
...
/* pl */ {IDCLS_DISABLE_WARP_MODE_PL, "Wy3Å}cz tryb przyspieszony"},
...
/* pl */ {IDCLS_SPECIFY_ISO_LANG_CODE_PL, "OkreÅ˜l kod iso jezyka"},
...
/* pl */ {IDCLS_ENABLE_PLUS256K_EXPANSION_PL, "W3Å}cz rozszerzenie PLUS256K RAM"},
...
/* pl */ {IDCLS_DISABLE_PLUS256K_EXPANSION_PL, "Wy3Å}cz rozszerzenie PLUS256K RAM"},
...
/* pl */ {IDCLS_SPECIFY_PLUS256K_NAME_PL, "OkreÅ˜l nazwe obrazu PLUS256K"},
...
/* pl */ {IDCLS_ENABLE_PLUS60K_EXPANSION_PL, "W3Å}cz rozszerzenie RAM PLUS60K"},
...
/* pl */ {IDCLS_DISABLE_PLUS60K_EXPANSION_PL, "Wy3Å}cz rozszerzenie PLUS60K RAM"},
...
/* pl */ {IDCLS_SPECIFY_PLUS60K_NAME_PL, "OkreÅ˜l nazwe obrazu PLUS60K"},
...
/* pl */ {IDCLS_ENABLE_C64_256K_EXPANSION_PL, "W3Å}cz rozszerzenie 256K RAM"},
...
/* pl */ {IDCLS_DISABLE_C64_256K_EXPANSION_PL, "Wy3Å}cz rozszerzenie 256K RAM"},
...
/* pl */ {IDCLS_SPECIFY_C64_256K_NAME_PL, "OkreÅ˜l nazwe obrazu 256K"},
...
/* pl */ {IDCLS_ENABLE_CS256K_EXPANSION_PL, "W3Å}cz rozszerzenie CSORY 256K RAM"},
...
/* pl */ {IDCLS_ENABLE_H256K_EXPANSION_PL, "W3Å}cz rozszerzenie HANNES 256K RAM"},
...
/* pl */ {IDCLS_ENABLE_H1024K_EXPANSION_PL, "W3Å}cz rozszerzenie HANNES 1024K RAM"},
...
/* pl */ {IDCLS_ENABLE_H4096K_EXPANSION_PL, "W3Å}cz rozszerzenie HANNES 4096K RAM"},
...
/* pl */ {IDCLS_SPECIFY_DTV_REVISION_PL, "OkreÅ˜l wersje DTV (2: DTV2, 3: DTV3)"},
...
/* pl */ {IDCLS_ENABLE_DTV_BLITTER_LOG_PL, "W3Å}cz logi blittera DTV."},
...
/* pl */ {IDCLS_DISABLE_DTV_BLITTER_LOG_PL, "Wy3Å}cz logi blittera DTV."},
...
/* pl */ {IDCLS_ENABLE_DTV_DMA_LOG_PL, "W3Å}cz logowanie DTV DMA"},
...
/* pl */ {IDCLS_DISABLE_DTV_DMA_LOG_PL, "Wy3Å}cz logowanie DTV DMA"},
...
/* pl */ {IDCLS_SPECIFY_C64DTVROM_NAME_PL, "OkreÅ˜l nazwe obrazu ROM C64DTV"},
...
/* ko */ {IDCLS_ENABLE_C64DTVROM_RW_KO, "C64DTV ROM AI1IAo?! ?2Å}a Åã!ÅLECIÅãO CIÅ}a"},
/* nl */ {IDCLS_ENABLE_C64DTVROM_RW_NL, "Aktiveer schrijven naar DTV ROM bestand"},
/* pl */ {IDCLS_ENABLE_C64DTVROM_RW_PL, "W3Å}cz zapis do obrazu ROM C64DTV"},
...
/* pl */ {IDCLS_DISABLE_C64DTVROM_RW_PL, "Wy3Å}cz zapis do obrazu ROM C64DTV"},
...
/* pl */ {IDCLS_ENABLE_DTV_FLASH_LOG_PL, "W3Å}cz logi uk3adu flash DTV."},
...
/* pl */ {IDCLS_DISABLE_DTV_FLASH_LOG_PL, "Wy3Å}cz logi uk3adu flash DTV."},
...
/* pl */ {IDCLS_USE_AS_DIRECTORY_FLASH_FS_PL, "U?yj <nazwa> jako katalogu urzÅ}dzenia systemu plikow flash"},
...
/* pl */ {IDCLS_ENABLE_TRUE_FLASH_FS_PL, "W3Å}cz prawdziwy sprzetowy system plikow flash"},
...
/* pl */ {IDCLS_DISABLE_TRUE_FLASH_FS_PL, "Wy3Å}cz prawdziwy system plikow flash"},
...
/* pl */ {IDCLS_ENABLE_MIDI_EMU_PL, "W3Å}cz emulacje MIDI"},
...
/* pl */ {IDCLS_DISABLE_MIDI_EMU_PL, "Wy3Å}cz emulacje MIDI"},
...
/* pl */ {IDCLS_ENABLE_DIGIBLASTER_PL, "W3Å}cz dodatek digiblaster"},
...
/* pl */ {IDCLS_DISABLE_DIGIBLASTER_PL, "Wy3Å}cz dodatek digiblaster"},
...
/* pl */ {IDCLS_ENABLE_PLUS4SPEECH_PL, "W3Å}cz rozszerzenie mowy v364"},
...
/* pl */ {IDCLS_DISABLE_PLUS4SPEECH_PL, "Wy3Å}cz rozszerzenie mowy v364"},
...
/* pl */ {IDCLS_ENABLE_SIDCARTJOY_PL, "W3Å}cz joystick kartrid?a SID"},
...
/* pl */ {IDCLS_DISABLE_SIDCARTJOY_PL, "Wy3Å}cz joystick kartrid?a SID"},
...
/* pl */ {IDCLS_ENABLE_SFX_SE_PL, "W3Å}cz kartrid? SFX Sound Expander"},
...
/* pl */ {IDCLS_DISABLE_SFX_SE_PL, "Wy3Å}cz kartrid? SFX Sound Expander"},
...
/* pl */ {IDCLS_SET_YM_CHIP_TYPE_PL, "OkreÅ˜l typ uk3adu YM (3526 / 3812)"},
...
/* pl */ {IDCLS_ENABLE_SFX_SS_PL, "W3Å}cz kartrid? SFX Sound Sampler"},
...
/* pl */ {IDCLS_DISABLE_SFX_SS_PL, "Wy3Å}cz kartrid? SFX Sound Sampler"},
...
/* ko */ {IDCLS_ENABLE_LIGHTPEN_EMULATION_KO, "Å˜oAIARAa ?!1ÅãÅE1?iAI Å‚c?eÅã!ÅLEAE CIÅ}a"},
/* nl */ {IDCLS_ENABLE_LIGHTPEN_EMULATION_NL, "Activeer de lichtpen emulatie"},
/* pl */ {IDCLS_ENABLE_LIGHTPEN_EMULATION_PL, "W3Å}cz emulacje piora Å˜wietlnego"},
...
/* pl */ {IDCLS_DISABLE_LIGHTPEN_EMULATION_PL, "Wy3Å}cz emulacje piora Å˜wietlnego"},
...
/* pl */ {IDCLS_SET_LIGHTPEN_TYPE_PL, "OkreÅ˜l typ piora Å˜wietlnego"},
...
/* pl */ {IDCLS_ENABLE_EASYFLASH_JUMPER_PL, "W3Å}cz prze3Å}cznik EasyFlash"},
...
/* pl */ {IDCLS_DISABLE_EASYFLASH_JUMPER_PL, "Wy3Å}cz prze3Å}cznik EasyFlash"},
...
/* pl */ {IDCLS_ENABLE_EASYFLASH_CRT_WRITING_PL, "W3Å}cz zapis do obrazu .crt EasyFlash"},
...
/* pl */ {IDCLS_DISABLE_EASYFLASH_CRT_WRITING_PL, "Wy3Å}cz zapis do obrazu .crt EasyFlash"},
...
/* pl */ {IDCLS_ENABLE_DIGIMAX_PL, "W3Å}cz kartrid? DigiMAX"},
...
/* pl */ {IDCLS_DISABLE_DIGIMAX_PL, "Wy3Å}cz kartrid? DigiMAX"},
