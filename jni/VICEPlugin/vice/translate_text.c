...
/* es */ {IDGS_PLAYBACK_ERROR_DIFFERENT_ES, "Error de reproducci?n: %s diferente desde linea %d del fichero de depuraci?n%06d"},
...
/* es */ {IDGS_CANT_FIND_SECTION_END_SNAP_ES, "No puedo encontrar secci?n eventos en fin fichero volcado memoria."},
...
/* es */ {IDGS_WRITE_TO_SOUND_DEVICE_FAILED_ES, "Fallo en grabaci?n perif?rico sonido."},
...
/* es */ {IDGS_INIT_FAILED_FOR_DEVICE_S_ES, "Fallo inicializaci?n para perif?rico `%s'."},
...
/* es */ {IDGS_DEVICE_S_NOT_FOUND_SUPPORT_ES, "Perif?rico '%s' no encontrado o soportado."},
...
/* es */ {IDGS_RECORD_DEVICE_S_NOT_EXIST_ES, "No existe el perif?rico %s de grabaci?n "},
...
/* es */ {IDGS_RECORD_DIFFERENT_PLAYBACK_ES, "Periferico de grabaci?n y reproducci?n tienen que ser diferentes"},
...
/* es */ {IDGS_WARNING_RECORDING_REALTIME_ES, "?Precauci?n! perif?rico de grabaci?n %s parece ser un periferico en tiempo real"},
...
/* es */ {IDGS_RECORD_NOT_SUPPORT_SOUND_PAR_ES, "El perif?rico de grabaci?n no soporta los actuales parametros de sonido"},
...
/* es */ {IDGS_FRAGMENT_PROBLEMS_ES, "Problema de fragmentaci?n"},
...
/* es */ {IDGS_STORE_SOUNDDEVICE_FAILED_ES, "Almacenamiento en perif?rico de sonido fallido"},
...
/* es */ {IDGS_IO_READ_COLL_AT_X_FROM_ES, "Entrada/Salida real colisi?n en %X para"},
...
/* es */ {IDGS_ALL_DEVICES_DETACHED_ES, ".\nTodos los perif?ricos nombrados ser?n desconectados."},
...
/* es */ {IDGS_ABBREVIATION_S_ES, "Abreviaci?n: %s\n"},
...
/* es */ {IDGS_MON_GOTO_DESCRIPTION_ES, "Cambiar el  PC con direcci?n y continuar la ejecuci?n"},
...
/* es */ {IDGS_MON_EXPORT_DESCRIPTION_ES, "Imprimir lista perif?ricos insertados en puertos de expansi?n."},
...
/* es */ {IDGS_MON_NEXT_DESCRIPTION_ES, "Avanzar a la siguiente instrucci?n.  Subrutinas ser?n tratadas como\ninstrucciones simples."},
...
/* es */ {IDGS_MON_RETURN_DESCRIPTION_ES, "Continuar ejecuci?n y volver al monitor justo antes que la siguiente\nRTS o RTI sea ejecutada."},
...
/* es */ {IDGS_MON_STEP_DESCRIPTION_ES, "Salto simple a traves de la instrucci?n.  el CONTADOR permite el salto de\nm?s de una instrucci?n a la vez."},
...
/* es */ {IDGS_MON_STOPWATCH_DESCRIPTION_ES, "Imprimir contador de ciclos del perif?rico actual. 'reset' pone el contador a 0."},
...
/* es */ {IDGS_SYMBOL_TABLE_COMMANDS_ES, "Tabla s?mbolo comando:"},
...
/* es */ {IDGS_MON_ADD_LABEL_DESCRIPTION_ES, "<espacio memoria> es uno de: C: 8: 9: 10: 11:\n<direcci?n>  es la direcci?n donde estar? la etiquetal.\n<letiqueta>   es el nombre de la etiqueta; debe empezar con un punto (\".\").\n\nMapea la direcci?n dada a una etiqueta que se usar? cuando se inserte\nc?digo ensamblador y se mostrar? durante el desensamblado.  Adicionalmente\npuede ser usada siempre que se deba especificar una direcci?n."},
...
/* es */ {IDGS_MON_WRITE_DESCRIPTION_ES, "Grabar el dato especificado en `direcci?n'."},
...
/* es */ {IDGS_INSTRUCTION_ES, "Insturcci?n"},
...
/* es */ {IDGS_MON_ASSEMBLE_DESCRIPTION_ES, "Ensambla instrucciones en la direcci?n especificada.  Si s?lo se\nespecifica una instrucci?n, entra en modo ensamblador, (entrar \nuna linea vacia para salir)."},
...
/* es */ {IDGS_ADDRESS_RANGE_ES, "Rango de direcci?n"},
...
/* es */ {IDGS_CHECKNUM_ES, "n?mero comprobaci?n"},
...
/* es */ {IDGS_MON_DELETE_DESCRIPTION_ES, "Borrar punto comprobaci?n `n?mero comprobaci?n'."},
...
/* es */ {IDGS_MON_DISASS_DESCRIPTION_ES, "Desensamblar instrucciones. Si se especifican dos direcciones, se\nusan como direcciones de inicio y final. Si solo se suministra una, ser?\ntratada como direcci?n de inicio y un n?mero por defecto de  instrucciones\nser?n desensambladas. Si no se especifica ninguna direcci?n, un n?mero\npor defecto de instrucciones se desensamblaran desde la direcci?n pre\ndefinida"},
...
/* es */ {IDGS_ADDRESS_OPT_RANGE_ES, "Rango direcci?n"},
...
/* es */ {IDGS_MON_II_DESCRIPTION_ES, "Mostrar contenidos de memoria con c?digo texto pantalla."},
...
/* es */ {IDGS_MON_MEMCHAR_DESCRIPTION_ES, "Mostrar el contenido de memoria como datos de caracter. Si s?lo se una\ndirecci?n es especificada, s?lo se muestra un caracter. Si no se da\nninguna direcci?n, se usa la direcci?n 'dot'."},
...
/* es */ {IDGS_MON_MEMSPRITE_DESCRIPTION_ES, "Mostrar el contenido de memoria como datos de sprites, Si s?lo se \nespecifica una direcci?n, solo se muestra un sprite. Si no se dan\ndirecciones, se usa la direcci?n 'dot'."},
...
/* es */ {IDGS_MON_BREAK_DESCRIPTION_ES, "Poner punto de ruptura. Si no se d? direcci?n, se imprime el actual punto\nde control. Si se d? una direcci?n, se activa un punto de ruptura en la misma\ny se imprime el n?mero de punto de ruptura.\n`load|store|exec' es cualquiera de `load', `store' or `exec' (o combinaci?n\nde ellos) a especificar en que operacion el monitor se detiene. Si no se\nespecifica, el monitor se detiene en `exec'.\nSe puede especificar tambien una condici?n para el punto de ruptura.\nPara m?s informaci?n sobre condiciones, ver el comandoa CONDITION."},
...
/* sv */ {IDGS_MON_BREAK_DESCRIPTION_SV, "S?tt en ?vervakningspunkt, Om ingen adress anges visas de \n?vervakningspunkter som ?r giltiga.\nOm en adress anges s?tts en brytpunkt p? den adressen och dess\nnummer visas.\n\"load|store|exec\" ?r antingen \"load\", \"store\" eller \"exec\"\n(eller en kombination d?rutav) f?r att ange p? vilken operation\nmonitorn stoppar. Om det inte anges bryter monitorn p? \"exec\".\nEtt villkorsuttryck kan ocks? anges f?r brytpunkten.\nF?r mer information om villkor, se kommandot CONDITION."},
/* tr */ {IDGS_MON_BREAK_DESCRIPTION_TR, "Kesme noktas? koy, e?er adres girilmemi?se, ge?erli mevcut izleme\nnoktalar? yazd?r?l?r.\nE?er bir adres girilmi?se, o adres i?in bir kesme noktas? i?aretlenir\nve kesme noktas? say?s? yazd?r?l?r.\n`y?kle|depola|y?r?t' i?in `y?kle', `depola' ya da `y?r?t' (ya da herhangi\nbir kombinasyonu) takip edilmek istenen operasyona g?re belirtilmelidir.\nE?er belirtilmemi?se, takip i?lemi `y?r?t'de sona erer.\nAyn? zamanda kesme noktas? i?in bir ko?ul ifadesi de belirtilebilir.\nKo?ullar ile ilgili daha ?ok bilgi almak i?in, CONDITION komutuna\nbakabilirsiniz."},
#endif
...
/* es */ {IDGS_MON_CONDITION_DESCRIPTION_ES, "Cada vez que un punto de control se examine, la condici?n se\nevaluar?. Si la condici?n es cierta, se activa el punto de control.\nSi no, se ignora. Si los registros est?n especificado en la condici?n,\nse usan los valores en el momento en el que se examina el punto\nde ruptura, no en el momento de poner la condicion.\nLa condici?n puede usar los registros (.A, .X, .Y, .PC, .SP)  y compararlos\nm (==, !=, <, >, <=, >=) con otros registros y constantes.\nLos registros pueden ser de otros perif?ricos, esto se denota por el\nprefijo de espacio memoria (ejm., c:, 8:, 9:, 10:, 11:\nEjemplos: .A == 0, .X == .Y, 8:.X == .X\n"},
...
/* es */ {IDGS_MON_UNTIL_DESCRIPTION_ES, "Si no se da direcci?n, se imprime el ?ltimo punto de ruptura v?lido.\nSi se da direcci?n, se activa un punto de ruptura para la direcci?n\ny se imprime el n?mero del punto de ruptura. El control se devuelve al\nemulador por el comando. El punto de ruputa se borra una vez se encuentra."},
...
/* es */ {IDGS_MON_WATCH_DESCRIPTION_ES, "Poner punto de visualizaci?n. Si no se d? direcci?n se mostrar? el\nactualmente v?lido. Si se d? una direcci?n simple, se pondr? un punto\nde visualizaci?n en la misma\nSi se d?n dos direcciones se activar? un punto de visualizaci?n para las\nlocalizaciones de memoria entre ambas direcciones.\n`load|store|exec' es cualquiera de `load', `store' or `exec' (o alguna com-\nbinaci?n de ellos) para especificar en que operaci?n el monitor se detiene\nSi no se especifica, Se detiene en  `load' y `store'.\n"},
...
/* sv */ {IDGS_MON_WATCH_DESCRIPTION_SV, "S?tt en ?vervakningspunkt. Om du inte anger n?gon adress, visas\nnu giltiga ?vervakningspunkter. Om du anger en ensam adress s?tts en\n?vervakningspunkt f?r adressen. Om tv? adresser anges s?tts en\n?vervakningspunkt f?r minnesomr?det mellan adresserna.\n\"load|store|exec\" ?r antingen \"load\". \"store\" eller \"exec\" (eller en\nkombination d?rutav) och anger vilken operation monitorn skall\nstoppa f?r. Om den inte anges stoppar emulatorn p? b?de \"load\" och\n\"store\".\n"},
/* tr */ {IDGS_MON_WATCH_DESCRIPTION_TR, "Bir g?r?nt?leme noktas? koy. E?er hi? adres verilmemi?se, mevcut ge?erli\ng?r?nt?leme noktalar? yazd?r?l?r. E?er tek bir adres belirtilmi?se,\ng?r?nt?leme noktas?n? o adrese koy.  E?er iki adres belirtilmi?se, g?r?nt?leme\nnoktas?n? o iki adres aras?nda kalan adreslere koy.\n`y?kle|depola|y?r?t' monit?r?n kesildi?i operat?re ba?l? olarak `y?kle'\n`depola' ya da `y?r?t' (ya da herhangi bir kombinasyonunda) i?lemlerinde\n?al??abilir. E?er belirtilmemi?se, monit?r `y?kle' ve `depola'da kesilecektir.\n"},
#endif
...
/* es */ {IDGS_MON_TRACE_DESCRIPTION_ES, "Poner punto rastreo. Si no se d? direcci?n, Se mostrar? el actualmente\nv?lido. Si se d? una s?la direcci?n, se activa un punto para esa direcci?n.\nSi se d?n dos, se activa el punto para las localizaciones de memoria entre\nlas dos direcciones.\n`load|store|exec' es cualquiera `load', `store' or `exec' (o una combina-\nci?n de ellas) para indicar en cual de ellas se detiene el monitor. Si no se\nespecifican el monitor rastrea todas las tres operaciones.\n"},
...
/* sv */ {IDGS_MON_TRACE_DESCRIPTION_SV, "S?tt en sp?rningspunkt. Om ingen adress anges visas befintliga\nsp?rningspunkter. Om du anger en ensam adress s?tts en sp?rningspunkt\nf?r adressen. Om tv? adresser anges s?tts en sp?rningspunkt f?r\nminnesomr?det mellan adresserna.\n\"load|store|exec\" ?r antingen \"load\", \"store\" eller \"exec\" (eller en\nkombination d?rutav) och anger vilken operation monitorn skall stoppa\nf?r. Om den inte anges sp?rar monitorn alla tre operationerna.\n"},
/* tr */ {IDGS_MON_TRACE_DESCRIPTION_TR, "Bir izleme noktas? koy. E?er bir adres belirtilmemi?se, mevcut ge?erli\nizleme noktalar? yazd?r?l?r. E?er tek bir adres belirtilmi?se, izleme\nnoktas?n? o adrese koy.  E?er iki adres belirtilmi?se, izleme noktas?n?\no iki adres aras?nda kalan adreslere koy.\n`y?kle|depola|y?r?t' monit?r?n kesildi?i operat?re ba?l? olarak `y?kle'\n`depola' ya da `y?r?t' (ya da herhangi bir kombinasyonunda) i?lemlerinde\n?al??abilir. E?er belirtilmemi?se, monit?r her ?? i?lemi de izleyecektir.\n"},
#endif
...
/* es */ {IDGS_MON_DEVICE_DESCRIPTION_ES, "Seleccionar el perif?rico memoria por defecto entre  `c:' o la\nunidad de disco especificada (`8:', `9:')."},
...
/* es */ {IDGS_MON_EXIT_DESCRIPTION_ES, "Dejar el monitor y volver a la ejecuci?n."},
...
/* es */ {IDGS_MON_ATTACH_DESCRIPTION_ES, "Inserta fichero en perif?rico (perif?rico 32=cartucho)"},
...
/* es */ {IDGS_MON_BLOAD_DESCRIPTION_ES, "Cargar el fichero especificado en memoria en la direccci?n indicada en\ndirecci?n. Si el perif?rico es 0 el fichero se lee desde sistema."},
...
/* es */ {IDGS_MON_BLOCK_READ_DESCRIPTION_ES, "Leer bloque en la pista y sector especificados. Si la direcci?n se\nespecifica, el dato se carga en memoria, si no, el dato se muestra\nusando el tipo dato por defecto."},
...
/* es */ {IDGS_MON_BSAVE_DESCRIPTION_ES, "Grabar la memoria entre direcci?n 1 y direcci?n2 al fichero indicado.\nSi el perif?rico es 0, el fichero se graba en el fichero del sistema."},
...
/* es */ {IDGS_MON_BLOCK_WRITE_DESCRIPTION_ES, "Grabar un bloque de datos en 'direcci?n' en la pista y sector indicados\ndel disco en la unidad de discos 8."},
...
/* tr */ {IDGS_MON_CD_DESCRIPTION_TR, "Ge?erli ?al??ma dizinini de?i?tir."},
#endif
...
/* es */ {IDGS_MON_DETACH_DESCRIPTION_ES, "Extraer fichero desde el perif?rico (perif?rico 32 = cartucho)"},
...
/* es */ {IDGS_MON_LOAD_DESCRIPTION_ES, "Cargar el fichero especificado en la direcci?n de memoria indicada. Actualizar\npunteros BASIC apropiadamente si se carga en la memoria del ordenador\n(no en todos los emuladores).\nUsar direcci?n de dos bytes del fichero si no se indica otra direcci?n.\nSi el perif?rico es 0, el fichero se lee del sistema."},
...
/* es */ {IDGS_MON_SAVE_DESCRIPTION_ES, "Graba memoria entre direcci?n1 y direcci?n2 al fichero indicado.\nGraba direcci?n de carga de dos bytes.\nSi el periferico es 0, se graba en el sistema."},
...
/* es */ {IDGS_MON_CARTFREEZE_DESCRIPTION_ES, "Usar congelaci?n cartucho"},
...
/* es */ {IDGS_EXPRESSION_ES, "expresi?n"},
...
/* es */ {IDGS_MON_PRINT_DESCRIPTION_ES, "Evaluar la expresi?n y mostrar los resultados."},
...
/* es */ {IDGS_MON_STOP_DESCRIPTION_ES, "Detener comando de grabaci?n. Ver 'grabaci?n'"},
...
/* es */ {IDCLS_ENABLE_AUTOSTART_HANDLE_TDE_ES, "Manejar en autoarranque emulaci?n de disco verdadera"},
...
/* es */ {IDCLS_DISABLE_AUTOSTART_HANDLE_TDE_ES, "No manejar en autoarranque emulaci?n de disco verdadera"},
...
/* hu */ {IDCLS_SET_DISK_IMAGE_FOR_AUTOSTART_PRG_HU, "Lmeez k?pm?s megad?sa PRG automatikus ind?t?shoz"},
...
/* sv */ {IDCLS_SET_AUTOSTART_DELAY_SV, "Ange inledande f?rdr?jning f?r autostart (0: anv?nd standard)"},
...
/* sv */ {IDCLS_ENABLE_AUTOSTART_RANDOM_DELAY_SV, "Aktivera slumpm?ssig inledande autostartf?rdr?jning"},
...
/* sv */ {IDCLS_DISABLE_AUTOSTART_RANDOM_DELAY_SV, "Inaktivera slumpm?ssig inledande autostartf?rdr?jning"},
...
/* es */ {IDCLS_PATCH_KERNAL_TO_REVISION_ES, "Parchear la ROM Kernal a la versi?n <revisi?n>"},
...
/* es */ {IDCLS_SPECIFY_KEYMAP_FILE_INDEX_ES, "Especificar ?ndice del fichero mapa del teclado (0=simb?lico, 1=posicional)"},
...
/* es */ {IDCLS_SPECIFY_SYM_KEYMAP_FILE_NAME_ES, "Especificar nombre fichero del mapa de teclado simb?lico"},
...
/* es */ {IDCLS_ENABLE_INT_FUNC_ROM_ES, "Permitir ROM funci?n interna"},
...
/* ko */ {IDCLS_ENABLE_INT_FUNC_ROM_KO, "????? Function ROM ?? ????????? ???"},
/* nl */ {IDCLS_ENABLE_INT_FUNC_ROM_NL, "Activeer de interne functie ROM"},
/* pl */ {IDCLS_ENABLE_INT_FUNC_ROM_PL, "W??cz wewn?trzny Function ROM"},
...
/* es */ {IDCLS_DISABLE_INT_FUNC_ROM_ES, "Deshabilitar ROM funci?n interna"},
...
/* es */ {IDCLS_ENABLE_EXT_FUNC_ROM_ES, "Permitir ROM funci?n externa"},
...
/* ko */ {IDCLS_ENABLE_EXT_FUNC_ROM_KO, "??? Function ROM ?? ????????? ???"},
/* nl */ {IDCLS_ENABLE_EXT_FUNC_ROM_NL, "Activeer de externe functie ROM"},
/* pl */ {IDCLS_ENABLE_EXT_FUNC_ROM_PL, "W??cz zewn?trzny Function ROM"},
...
/* es */ {IDCLS_DISABLE_EXT_FUNC_ROM_ES, "Deshabilitar ROM funci?n externa"},
...
/* es */ {IDCLS_PETREU_SIZE_ES, "Tama?o de PET Ram y Unidad Expansi?n"},
...
/* es */ {IDCLS_RAMCART_SIZE_ES, "Tama?o expansi?n RAMCart"},
...
/* ko */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_ENABLE_KO, "MMC Replay EEPROM ????? ?? ???? ??????? ???"},
...
/* es */ {IDCLS_ALLOW_WRITING_TO_MMC_REPLAY_IMAGE_ES, "Permtir grabaci?n en imagen MMC Replay"},
...
/* es */ {IDCLS_REU_SIZE_ES, "Tama?o unidad expansion RAM"},
...
/* es */ {IDCLS_TFE_INTERFACE_ES, "Seleccionar interface sistema ethernet para emulaci?n TFE"},
...
/* es */ {IDCLS_ENABLE_TFE_AS_RRNET_ES, "Permitir emulaci?n TFE en modo RRNet"},
...
/* es */ {IDCLS_DISABLE_TFE_AS_RRNET_ES, "Deshabilitar emulaci?n TFE en modo RRNet"},
...
/* ko */ {IDCLS_ATTACH_CRT_CART_KO, "CRT ?????? ??????? ????????y?"},
...
/* ko */ {IDCLS_ATTACH_GENERIC_8KB_CART_KO, "8kb ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_GENERIC_16KB_CART_KO, "16kb ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_EASY_FLASH_CART_KO, "EasyFlash ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_RETRO_REPLAY_CART_KO, "64KB Retro Replay ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_IDE64_CART_KO, "64kb IDE64 ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_ATOMIC_POWER_CART_KO, "32kb Atomic Power ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_EPYX_FASTLOAD_CART_KO, "8kb Epyx FastLoad ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_SS5_CART_KO, "64KB Super Snapshot V5 ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_CBM_IEEE488_CART_KO, "IEEE-488 ????????? ?????? ??????? ???????????"},
...
/* ko */ {IDCLS_ATTACH_RAW_MAGIC_FORMEL_CART_KO, "Magic Formel ?????? ??????? ???????"},
...
/* ko */ {IDCLS_ATTACH_RAW_MMC_REPLAY_CART_KO, "512KB MMC Replay ?????? ??????? ???????"},
...
/* es */ {IDCLS_SET_AMOUNT_CYLINDERS_IDE64_ES, "Seleccionar n?mero de cilindros para emulaci?n IDE64"},
...
/* es */ {IDCLS_SET_AMOUNT_HEADS_IDE64_ES, "Seleccionar n?mero de cabezas para emulaci?n IDE64"},
...
/* es */ {IDCLS_SET_AMOUNT_SECTORS_IDE64_ES, "Seleccionar n?mero de sectores para emulaci?n IDE64"},
...
/* ko */ {IDCLS_AUTODETECT_IDE64_GEOMETRY_KO, "????? ??? ??????? a??"},
...
/* es */ {IDCLS_IDE64_V4_ES, "Emular versi?n 4 hardware"},
...
/* es */ {IDCLS_IDE64_PRE_V4_ES, "Emular preversi?n 4 hardware"},
...
/* es */ {IDCLS_SPECIFY_KEYMAP_INDEX_ES, "Especificar ?ndice fichero teclado"},
...
/* es */ {IDCLS_SPECIFY_GFX_SYM_KEYMAP_NAME_ES, "Especificar nombre fichero graficos teclado simb?lico"},
...
/* es */ {IDCLS_ENABLE_DRIVE_SOUND_ES, "Permitir emulaci?n de sonido en unidad de discos"},
...
/* pl */ {IDCLS_ENABLE_DRIVE_SOUND_PL, "W??cz emulacj? odg?os?w stacji dysk?w"},
/* ru */ {IDCLS_ENABLE_DRIVE_SOUND_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_ENABLE_DRIVE_SOUND_SV, "Aktivera ljudemulering f?r diskettstationer"},
...
/* es */ {IDCLS_DISABLE_DRIVE_SOUND_ES, "Inhabilitar emulaci?n de sonido wn unidad de discos"},
...
/* pl */ {IDCLS_DISABLE_DRIVE_SOUND_PL, "Wy??cz emulacj? odg?os?w stacji dysk?w"},
/* ru */ {IDCLS_DISABLE_DRIVE_SOUND_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_DISABLE_DRIVE_SOUND_SV, "Inaktivera ljudemulering f?r diskettstationer"},
...
/* es */ {IDCLS_SET_IDLE_METHOD_ES, "Seleccionar metodo tiempo inactico (0: sin intercepci?n, 1:saltar ciclos, 2:interceptar tiempos inactivos)"},
...
/* ko */ {IDCLS_ENABLE_PROFDOS_KO, "Professional DOS ????????? ???"},
...
/* es */ {IDCLS_SET_SATURATION_ES, "Seleccionar saturaci?n calculada en paleta interna [1000]"},
...
/* es */ {IDCLS_SET_ODDLINES_OFFSET_ES, "Seleccionar a?adido fase trasporte color en lineas impares [750]"},
...
/* es */ {IDCLS_SET_SCANLINE_SHADE_ES, "Cantidad de lineas sombra escaneo para emulaci?n CRT [667]"},
...
/* es */ {IDCLS_SPECIFY_PRT_DRIVER_4_NAME_ES, "Especificar nombre controlador impresora perif?rico #4"},
...
/* es */ {IDCLS_SPECIFY_PRT_DRIVER_5_NAME_ES, "Especificar nombre controlador impresora perif?rico #5"},
...
/* es */ {IDCLS_SPECIFY_PRT_DRIVER_USR_NAME_ES, "Especificar nombre controlador impresi?n para puerto impresora"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_4_ES, "Seleccionar tipo para el perif?rico #4 (0:NO 1:FS, 2:REAL)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_5_ES, "Seleccionar tipo para el perif?rico #5 (0:NO 1:FS, 2:REAL)"},
...
/* es */ {IDCLS_SPECIFY_OUTPUT_DEVICE_4_NAME_ES, "Especificar nombre perif?rico de salida para perif?rico #4"},
...
/* es */ {IDCLS_SPECIFY_OUTPUT_DEVICE_5_NAME_ES, "Especificar nombre perif?rico de salida para perif?rico #5"},
...
/* es */ {IDCLS_SPECIFY_OUTPUT_DEVICE_USR_NAME_ES, "Especificar nombre perif?rico de salida para puerto usuario impresora"},
...
/* es */ {IDCLS_ENABLE_VIDEO_CACHE_ES, "Permitier cach? de video"},
...
/* es */ {IDCLS_DISABLE_VIDEO_CACHE_ES, "Deshabilitar cach? de video"},
...
/* es */ {IDCLS_P_BASE_ADDRESS_ES, "<Direcci?n base>"},
...
/* es */ {IDCLS_SPECIFY_SID_2_ADDRESS_ES, "Especificar direcci?n base para el segundo ISD"},
...
/* es */ {IDCLS_SPECIFY_SID_3_ADDRESS_ES, "Especificar direcci?n base para el tercer SID"},
...
/* sv */ {IDCLS_SPECIFY_SID_3_ADDRESS_SV, "Ange basadress f?r tredje SID"},
/* tr */ {IDCLS_SPECIFY_SID_3_ADDRESS_TR, "3?nc? SID i?in taban adresini belirt"},
#endif
...
/* es */ {IDCLS_SPECIFY_MEMORY_CONFIG_ES, "Especificar configuraci?n de memoria"},
...
/* es */ {IDCLS_SET_BORDER_MODE_ES, "Seleccionar VIC-II tipo de borde (0: normal, 1: completo, 2: depuraci?n)"},
...
/* es */ {IDCLS_ENABLE_DOUBLE_SIZE_ES, "Permitir tama?o doble"},
...
/* es */ {IDCLS_DISABLE_DOUBLE_SIZE_ES, "Deshabilitar tama?o doble"},
...
/* es */ {IDCLS_ENABLE_AUDIO_LEAK_ES, "Permitir emulaci?n audio leak"},
...
/* pl */ {IDCLS_ENABLE_AUDIO_LEAK_PL, "W??cz emulacj? brud?w w d?wi?ku"},
/* ru */ {IDCLS_ENABLE_AUDIO_LEAK_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_ENABLE_AUDIO_LEAK_SV, "Aktivera emulering av audiol?ckage"},
/* tr */ {IDCLS_ENABLE_AUDIO_LEAK_TR, "Ses ka?a?? em?lasyonunu aktif et"},
#endif
...
/* es */ {IDCLS_DISABLE_AUDIO_LEAK_ES, "Deshabilitar emulaci?n audio leak"},
...
/* pl */ {IDCLS_DISABLE_AUDIO_LEAK_PL, "Wy??cz emulacj? brud?w w d?wi?ku"},
/* ru */ {IDCLS_DISABLE_AUDIO_LEAK_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_DISABLE_AUDIO_LEAK_SV, "Inaktivera emulering av audiol?ckage"},
/* tr */ {IDCLS_DISABLE_AUDIO_LEAK_TR, "Ses ka?a?? em?lasyonunu pasifle?tir"},
#endif
...
/* pl */ {IDCLS_ENABLE_HARDWARE_SCALING_PL, "W??cz skalowanie sprz?towe"},
...
/* es */ {IDCLS_SET_VIDEO_FILTER_ES, "Seleccionar filtro de renderizador, 0:no, 1:emulaci?n CRT, 2: escala2x"},
...
/* tr */ {IDCLS_SET_VIDEO_FILTER_TR, "G?r?nt? olu?turma filitresini se?, 0:yok, 1:CRT em?lasyonu, 2: geni?let2x"},
#endif
...
/* es */ {IDCLS_P_DEVICE_ES, "<perif?rico>"},
...
/* es */ {IDCLS_SELECT_FULLSCREEN_DEVICE_ES, "Seleccionar perif?rico pantalla completa"},
...
/* es */ {IDCLS_SPECIFY_ACIA_RS232_DEVICE_ES, "Specificar perif?rico RS232 con el que funcionar? esta ACIA"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_8_ES, "Seleccionar tipo para perif?rico #8  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_9_ES, "Seleccionar tipo para perif?rico #9  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_10_ES, "Seleccionar tipo para perif?rico #10  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_SET_DEVICE_TYPE_11_ES, "Seleccionar tipo para perif?rico #11  (0: NINGUNO, 1: FILESYSTEM, 2: OPENCBM, 3: BLOCK DEVICE)"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_8_ES, "Insertar imagen disco s?lo lectura para unidad disco #8"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_8_ES, "Insertar imagen disco s?lo lectura/grabaci?n (si es posible) para unidad disco #8"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_9_ES, "Insertar imagen disco s?lo lectura para unidad disco #9"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_9_ES, "Insertar imagen disco s?lo lectura/grabaci?n (si es posible) para unidad disco #9"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_10_ES, "Insertar imagen disco s?lo lectura para unidad disco #10"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_10_ES, "Insertar imagen disco s?lo lectura/grabaci?n (si es posible) para unidad disco #10"},
...
/* es */ {IDCLS_ATTACH_READ_ONLY_11_ES, "Insertar imagen disco s?lo lectura para unidad disco #11"},
...
/* es */ {IDCLS_ATTACH_READ_WRITE_11_ES, "Insertar imagen disco s?lo lectura/grabaci?n (si es posible) para unidad disco #11"},
...
/* es */ {IDCLS_SET_CYCLES_ADDED_GAP_TAP_ES, "Seleccionar n?mero ciclos a?adidos en cada espacio en la cinta"},
...
/* es */ {IDCLS_TRACE_MODE_ES, "Modo de rastreo (0=normal, 1=peque?o, 2=historial)"},
...
/* es */ {IDCLS_ENABLE_MOUSE_GRAB_ES, "Permitir captuar del rat?n"},
...
/* es */ {IDCLS_SELECT_MOUSE_JOY_PORT_ES, "Seleccionar el puerto de joystick en el que esta insertado el rat?n"},
...
/* de */ {IDCLS_SELECT_MOUSE_TYPE_DE, "Maus typ w?hlen (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = Paddles, 4 = CX-22, 5 = ST)"},
/* es */ {IDCLS_SELECT_MOUSE_TYPE_ES, "Seleccionar tipo de rat?n  (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = Paddles, 4 = CX-22, 5 = ST)"},
...
/* pl */ {IDCLS_SELECT_MOUSE_TYPE_PL, "Ustaw typ myszy (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = pokr?t?a, 4 = CX-22, 5 = ST)"},
/* ru */ {IDCLS_SELECT_MOUSE_TYPE_RU, ""},  /* fuzzy */
/* sv */ {IDCLS_SELECT_MOUSE_TYPE_SV, "V?lj mustyp (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = paddlar, 4 = CX-22, 5 = ST)"},
/* tr */ {IDCLS_SELECT_MOUSE_TYPE_TR, "Mouse tipini se?in (0 = 1351, 1 = NEOS, 2 = Amiga, 3 = Paddles, 4 = CX-22, 5 = ST)"},
#endif
...
/* es */ {IDCLS_SET_FIRST_RAM_ADDRESS_VALUE_ES, "Seleccionar el valor para la primera direcci?n RAM despues del encendido"},
...
/* es */ {IDCLS_SET_SOUND_BUFFER_SIZE_MSEC_ES, "Seleccionar tama?o bufer sonido en <valor>mseg"},
...
/* es */ {IDCLS_SET_SOUND_FRAGMENT_SIZE_ES, "Seleccionar tama?o fragmento  (0 = peque?o, 1 = medio, 2 = grande)"},
...
/* es */ {IDCLS_SPECIFY_SOUND_DRIVER_PARAM_ES, "Especificar parametros de inicializaci?n para el controlador de sonido"},
...
/* es */ {IDCLS_SPECIFY_RECORDING_SOUND_DRIVER_ES, "Especificar controlador grabaci?n sonido"},
...
/* es */ {IDCLS_SPECIFY_REC_SOUND_DRIVER_PARAM_ES, "Especificar parametros inicializaci?n para el controlador grabaci?n sonido "},
...
/* es */ {IDCLS_LIMIT_SPEED_TO_VALUE_ES, "Limitar la velocidad de emulaci?n al valor indicado"},
...
/* es */ {IDCLS_SPECIFY_ISO_LANG_CODE_ES, "Especificar el c?digo ISO para el idioma"},
...
/* es */ {IDCLS_ENABLE_PLUS256K_EXPANSION_ES, "Permitir expansi?n RAM PLUS256K"},
...
/* es */ {IDCLS_DISABLE_PLUS256K_EXPANSION_ES, "Deshabilitar expansi?n RAM PLUS256K"},
...
/* es */ {IDCLS_ENABLE_PLUS60K_EXPANSION_ES, "Permitir expansi?n RAM PLUS60K"},
...
/* es */ {IDCLS_DISABLE_PLUS60K_EXPANSION_ES, "Deshabilitar expansi?n RAM PLUS60K"},
...
/* es */ {IDCLS_PLUS60K_BASE_ES, "Direcci?n base de la expansi?n PLUS60K"},
...
/* es */ {IDCLS_ENABLE_C64_256K_EXPANSION_ES, "Permitir expansi?n RAM 256K"},
...
/* es */ {IDCLS_DISABLE_C64_256K_EXPANSION_ES, "Deshabilitar expansi?n RAM 256K"},
...
/* es */ {IDCLS_C64_256K_BASE_ES, "Direcci?n base de la expansi?n 256K"},
...
/* es */ {IDCLS_ENABLE_CS256K_EXPANSION_ES, "Permitir expansi?n RAM CSORY 256KB"},
...
/* es */ {IDCLS_ENABLE_H256K_EXPANSION_ES, "Permitir expansi?n RAM HANNES 256KB"},
...
/* es */ {IDCLS_ENABLE_H1024K_EXPANSION_ES, "Permitir expansi?n RAM HANNES 1024KB"},
...
/* es */ {IDCLS_ENABLE_H4096K_EXPANSION_ES, "Permitir expansi?n RAM HANNES 4096KB"},
...
/* ko */ {IDCLS_ENABLE_C64DTVROM_RW_KO, "C64DTV ROM ??????? ???? ??????? ???"},
...
/* ko */ {IDCLS_ENABLE_SIDCARTJOY_KO, "SID ?????? ?????? ???????"},
...
/* ko */ {IDCLS_DISABLE_SIDCARTJOY_KO, "SID ?????? ?????? ???????? ???"},
...
/* ko */ {IDCLS_ENABLE_SFX_SS_KO, "SFX Sound Sampler ?????? ?? ????????"},
...
/* es */ {IDCLS_ENABLE_LIGHTPEN_EMULATION_ES, "Permitir emulaci?n l?piz ?ptico"},
...
/* es */ {IDCLS_DISABLE_LIGHTPEN_EMULATION_ES, "Deshabilitar emulaci?n l?piz ?ptico"},
...
/* es */ {IDCLS_SET_LIGHTPEN_TYPE_ES, "Seleccionar tipo l?piz ?ptico"},
...
/* es */ {IDCLS_DIGIMAX_BASE_ES, "Direcci?n base para cartucho DigMAX"},
